...
if(EXISTS "${OpenCV_DIR}")
  ...
  if(EXISTS "${OpenCV_DIR}/OpenCVConfig.cmake")
    ...
    if(EXISTS ${OpenCV_INCLUDE_DIR})
      ...
      string(
        REGEX REPLACE
        ".*#define CV_SUBMINOR_VERSION[ \t]+([0-9]+).*"
        "\\1"
  ...
  foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
    find_library(
      ...
      NAMES "${__CVLIB}${CVLIB_SUFFIX}d" "lib${__CVLIB}${CVLIB_SUFFIX}d"
      PATHS "${OpenCV_DIR}/lib"
      NO_DEFAULT_PATH
    )
    find_library(
      OpenCV_${__CVLIB}_LIBRARY_RELEASE
      NAMES "${__CVLIB}${CVLIB_SUFFIX}" "lib${__CVLIB}${CVLIB_SUFFIX}"
      PATHS "${OpenCV_DIR}/lib"
      NO_DEFAULT_PATH
    )
...
if(OpenCV_FOUND)
  option(
    ...
    "Add some variable to make this script compatible with the other version of FindOpenCV.cmake"
    false
  )
