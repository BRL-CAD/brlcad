...
set(_UTAHRLE_SEARCH_NORMAL PATHS "$ENV{ProgramFiles}/utahrle" "$ENV{ProgramFiles${_UTAHRLE_x86}}/utahrle")
unset(_UTAHRLE_x86)
...
if(UTAHRLE_FOUND)
  ...
  if(NOT TARGET UTAHRLE::UTAHRLE)
    ...
    set_target_properties(UTAHRLE::UTAHRLE PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${UTAHRLE_INCLUDE_DIRS}")

    if(UTAHRLE_LIBRARY_RELEASE)
      set_property(TARGET UTAHRLE::UTAHRLE APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
      set_target_properties(UTAHRLE::UTAHRLE PROPERTIES IMPORTED_LOCATION_RELEASE "${UTAHRLE_LIBRARY_RELEASE}")
    endif()

    if(UTAHRLE_LIBRARY_DEBUG)
      set_property(TARGET UTAHRLE::UTAHRLE APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
      set_target_properties(UTAHRLE::UTAHRLE PROPERTIES IMPORTED_LOCATION_DEBUG "${UTAHRLE_LIBRARY_DEBUG}")
    endif()

    if(NOT UTAHRLE_LIBRARY_RELEASE AND NOT UTAHRLE_LIBRARY_DEBUG)
      set_property(TARGET UTAHRLE::UTAHRLE APPEND PROPERTY IMPORTED_LOCATION "${UTAHRLE_LIBRARY}")
    endif()
  endif()
endif()
