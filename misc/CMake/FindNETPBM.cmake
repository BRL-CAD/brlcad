...
# Normal search.
set(_NETPBM_x86 "(x86)")
set(_NETPBM_SEARCH_NORMAL PATHS "$ENV{ProgramFiles}/netpbm" "$ENV{ProgramFiles${_NETPBM_x86}}/netpbm")
unset(_NETPBM_x86)
...
if(NETPBM_FOUND)
  ...
  if(NOT TARGET NETPBM::NETPBM)
    add_library(NETPBM::NETPBM UNKNOWN IMPORTED GLOBAL)
    set_target_properties(NETPBM::NETPBM PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${NETPBM_INCLUDE_DIRS}")

    if(NETPBM_LIBRARY_RELEASE)
      set_property(TARGET NETPBM::NETPBM APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
      set_target_properties(NETPBM::NETPBM PROPERTIES IMPORTED_LOCATION_RELEASE "${NETPBM_LIBRARY_RELEASE}")
    endif()

    if(NETPBM_LIBRARY_DEBUG)
      set_property(TARGET NETPBM::NETPBM APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
      set_target_properties(NETPBM::NETPBM PROPERTIES IMPORTED_LOCATION_DEBUG "${NETPBM_LIBRARY_DEBUG}")
    endif()

    if(NOT NETPBM_LIBRARY_RELEASE AND NOT NETPBM_LIBRARY_DEBUG)
      set_property(TARGET NETPBM::NETPBM APPEND PROPERTY IMPORTED_LOCATION "${NETPBM_LIBRARY}")
    endif()
  endif()
endif()
