...
MACRO(TCL_BUNDLE_OPTION optname default_raw)
	...
	IF(NOT ${optname})
		...
		ELSE(default)
			...
			IF(${${CMAKE_PROJECT_NAME}_TCL} STREQUAL "SYSTEM" OR ${${CMAKE_PROJECT_NAME}_TCL} STREQUAL "BUNDLED (SYSTEM)")
				SET(${optname} "BUNDLED (SYSTEM)" CACHE STRING "Build bundled ${optname} libraries.")
			ENDIF(${${CMAKE_PROJECT_NAME}_TCL} STREQUAL "SYSTEM" OR ${${CMAKE_PROJECT_NAME}_TCL} STREQUAL "BUNDLED (SYSTEM)")
   ...
   TCL_BUNDLE_OPTION(${CMAKE_PROJECT_NAME}_${PKGNAME_UPPER} "") 
	...
	ELSE(${CMAKE_PROJECT_NAME}_${PKGNAME_UPPER} STREQUAL "BUNDLED" OR ${CMAKE_PROJECT_NAME}_${PKGNAME_UPPER} STREQUAL "BUNDLED (AUTO)")
		...
		IF(${wishcmd} STREQUAL "")
			...
			IF(NOT ${CMAKE_PROJECT_NAME}_${PKGNAME_UPPER} STREQUAL "SYSTEM" AND NOT ${CMAKE_PROJECT_NAME}_${PKGNAME_UPPER} STREQUAL "BUNDLED (SYSTEM)")
				# Can't test and we're not forced to system by either local settings or the toplevel - turn it on 
				SET(${CMAKE_PROJECT_NAME}_${PKGNAME_UPPER}_BUILD ON)
			ELSE(NOT ${CMAKE_PROJECT_NAME}_${PKGNAME_UPPER} STREQUAL "SYSTEM" AND NOT ${CMAKE_PROJECT_NAME}_${PKGNAME_UPPER} STREQUAL "BUNDLED (SYSTEM)")
			...
			ENDIF(NOT ${CMAKE_PROJECT_NAME}_${PKGNAME_UPPER} STREQUAL "SYSTEM" AND NOT ${CMAKE_PROJECT_NAME}_${PKGNAME_UPPER} STREQUAL "BUNDLED (SYSTEM)")
