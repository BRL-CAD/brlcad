...
MACRO(THIRD_PARTY_OPTION upper lower)
  ...
  OPTION(${CMAKE_PROJECT_NAME}_BUILD_LOCAL_${upper} "Build the local ${lower} library." ON)
  ...
  IF(NOT ${CMAKE_PROJECT_NAME}_BUILD_LOCAL_${upper})
    ...
    ELSE(${upper}_FOUND)
      MESSAGE(SEND_ERROR "${CMAKE_PROJECT_NAME}_BUILD_LOCAL_${upper} is ON, but ${upper}_LIBRARY is NOTFOUND.")
    ENDIF(${upper}_FOUND)
