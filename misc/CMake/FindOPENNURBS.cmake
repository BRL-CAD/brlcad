...
set(_OPENNURBS_SEARCH_NORMAL PATHS "$ENV{ProgramFiles}/openNURBS" "$ENV{ProgramFiles${_OPENNURBS_x86}}/openNURBS")
...
foreach(search ${_OPENNURBS_SEARCHES})
  find_path(
    ...
    NAMES opennurbs.h ${${search}}
    PATH_SUFFIXES include include/openNURBS openNURBS include/OpenNURBS OpenNURBS
  )
  find_path(
    OPENNURBS_X_INCLUDE_DIR
    NAMES opennurbs_x.h ${${search}}
    PATH_SUFFIXES include include/openNURBS openNURBS include/OpenNURBS OpenNURBS
  )
endforeach()
...
find_package_handle_standard_args(
  OPENNURBS
  REQUIRED_VARS OPENNURBS_LIBRARY OPENNURBS_INCLUDE_DIR OPENNURBS_X_INCLUDE_DIR
)
...
if(OPENNURBS_FOUND)
  ...
  if(NOT TARGET OPENNURBS::OPENNURBS)
    add_library(OPENNURBS::OPENNURBS UNKNOWN IMPORTED GLOBAL)
    set_target_properties(OPENNURBS::OPENNURBS PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${OPENNURBS_INCLUDE_DIRS}")

    if(OPENNURBS_LIBRARY_RELEASE)
      set_property(TARGET OPENNURBS::OPENNURBS APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
      set_target_properties(OPENNURBS::OPENNURBS PROPERTIES IMPORTED_LOCATION_RELEASE "${OPENNURBS_LIBRARY_RELEASE}")
    endif()

    if(OPENNURBS_LIBRARY_DEBUG)
      set_property(TARGET OPENNURBS::OPENNURBS APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
      set_target_properties(OPENNURBS::OPENNURBS PROPERTIES IMPORTED_LOCATION_DEBUG "${OPENNURBS_LIBRARY_DEBUG}")
    endif()
    ...
    if(TARGET Threads::Threads)
      set_property(TARGET OPENNURBS::OPENNURBS APPEND PROPERTY INTERFACE_LINK_LIBRARIES Threads::Threads)
    endif()
  endif()
endif()
