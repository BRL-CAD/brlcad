...
FOREACH(tcl_config_file ${TCLCONFIG_LIST}) 
	IF(NOT TCLVALID)
		...
		IF(TCLVALID)
			...
			SET(TCL_LIBRARY_SEARCH_PATHS "${TCL_LIBRARY_DIR1};${TCL_LIBRARY_DIR2};${TCL_LIBRARY_SEARCH_PATHS}")
				...
				FOREACH(tk_config_file ${TKCONFIG_LIST})
					IF(NOT TKVALID)
						...
						IF(TKVALID)
							...
							SET(TK_LIBRARY_SEARCH_PATHS "${TK_LIBRARY_DIR1};${TK_LIBRARY_DIR2};${TK_LIBRARY_SEARCH_PATHS}")
