			...
			FOREACH(SPATH ${PATHLIST})
				IF(NOT TCLVALID)
					...
					IF(dosearch)
						...
						FIND_LIBRARY(TCL_LIBRARY NAMES tcl${MAJORNUM}.${MINORNUM} tcl${MAJORNUM}${MINORNUM} PATHS ${TCL_LIBRARY_SEARCH_PATHS} NO_SYSTEM_PATH)
						FIND_LIBRARY(TCL_STUB_LIBRARY tclstub${MAJORNUM}.${MINORNUM} tclstub${MAJORNUM}${MINORNUM} PATHS ${TCL_LIBRARY_SEARCH_PATHS} NO_SYSTEM_PATH)
						...
						FIND_PATH(TCL_INCLUDE_PATH NAMES tcl.h tcl${MAJORNUM}.${MINORNUM} tcl${MAJORNUM}${MINORNUM} PATHS ${TCL_INCLUDE_SEARCH_PATHS} NO_SYSTEM_PATH)
					ENDIF(dosearch)
					VALIDATE_TCL(TCLVALID)
					IF(TCLVALID)
						IF(TCL_REQUIRE_TK)
							SET(TKVALID 0)
							RESET_TK_VARS()
							FIND_LIBRARY(TK_LIBRARY NAMES tk${MAJORNUM}.${MINORNUM} tk${MAJORNUM}${MINORNUM} PATHS ${TCL_LIBRARY_SEARCH_PATHS} NO_SYSTEM_PATH)
							FIND_LIBRARY(TK_STUB_LIBRARY tkstub${MAJORNUM}.${MINORNUM} tkstub${MAJORNUM}${MINORNUM} PATHS ${TCL_LIBRARY_SEARCH_PATHS} NO_SYSTEM_PATH)
							FIND_PROGRAM(TK_WISH NAMES wish${MAJORNUM}.${MINORNUM} wish${MAJORNUM}${MINORNUM} PATHS ${TCL_PROGRAM_SEARCH_PATHS} NO_SYSTEM_PATH)
							FIND_PATH(TK_INCLUDE_PATH NAMES tk.h tk${MAJORNUM}.${MINORNUM} tk${MAJORNUM}${MINORNUM} PATHS ${TCL_INCLUDE_SEARCH_PATHS} NO_SYSTEM_PATH)
							VALIDATE_TK(TKVALID)
							IF(NOT TKVALID)
								SET(TCLVALID 0)
								RESET_TCL_VARS()
