			...
			FOREACH(tk_config_file ${TKCONFIG_LIST}) 
				IF(NOT TKVALID)
					...
					IF(TKVALID)
						...
						FIND_LIBRARY(TK_STUB_LIBRARY tkstub tkstub${TK_MAJOR_VERSION}.${TK_MINOR_VERSION} tkstub${TK_MAJOR_VERSION}${TK_MINOR_VERSION} PATHS ${TK_STUB_LIB_PATH} ${TK_LIBRARY_DIR1} ${TK_LIBRARY_DIR2} NO_SYSTEM_PATH)
					ENDIF(TKVALID)
				ENDIF(NOT TKVALID)
