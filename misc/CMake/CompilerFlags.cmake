...
IF(${CMAKE_WORD_SIZE} MATCHES "32BIT" AND NOT ${BRLCAD-WORD_SIZE} MATCHES "AUTO" AND NOT MSVC)
...
ENDIF(${CMAKE_WORD_SIZE} MATCHES "32BIT" AND NOT ${BRLCAD-WORD_SIZE} MATCHES "AUTO" AND NOT MSVC)
