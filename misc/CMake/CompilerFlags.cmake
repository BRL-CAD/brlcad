...
MACRO(ADD_NEW_FLAG FLAG_TYPE NEW_FLAG)
	...
	IF(BUILD_TYPE)
		IF(CMAKE_${FLAG_TYPE}_FLAGS_${BUILD_TYPE})
			SET(CMAKE_${FLAG_TYPE}_FLAGS_${BUILD_TYPE} "${CMAKE_${FLAG_TYPE}_FLAGS_${BUILD_TYPE}} ${NFLAG}")
	...
	ELSE(BUILD_TYPE)
		SET(CMAKE_${FLAG_TYPE}_FLAGS "${CMAKE_${FLAG_TYPE}_FLAGS} ${NFLAG}")
	ENDIF(BUILD_TYPE)
	FOREACH(CFG_TYPE ${CMAKE_CONFIGURATION_TYPES})
		STRING(TOUPPER "${CFG_TYPE}" CFG_TYPE)
		IF(CMAKE_${FLAG_TYPE}_FLAGS_${CFG_TYPE})
			SET(CMAKE_${FLAG_TYPE}_FLAGS_${CFG_TYPE} "${CMAKE_${FLAG_TYPE}_FLAGS_${CFG_TYPE}} ${NFLAG}")
