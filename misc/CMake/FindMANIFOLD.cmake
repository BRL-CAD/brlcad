...
if(MANIFOLD_FOUND)
  ...
  if(NOT TARGET MANIFOLD::MANIFOLD)
    ...
    set_target_properties(MANIFOLD::MANIFOLD PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${MANIFOLD_INCLUDE_DIRS}")

    if(MANIFOLD_LIBRARY_RELEASE)
      set_property(TARGET MANIFOLD::MANIFOLD APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
      set_target_properties(MANIFOLD::MANIFOLD PROPERTIES IMPORTED_LOCATION_RELEASE "${MANIFOLD_LIBRARY_RELEASE}")
    endif()

    if(MANIFOLD_LIBRARY_DEBUG)
      set_property(TARGET MANIFOLD::MANIFOLD APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
      set_target_properties(MANIFOLD::MANIFOLD PROPERTIES IMPORTED_LOCATION_DEBUG "${MANIFOLD_LIBRARY_DEBUG}")
    endif()

    if(NOT MANIFOLD_LIBRARY_RELEASE AND NOT MANIFOLD_LIBRARY_DEBUG)
      set_property(TARGET MANIFOLD::MANIFOLD APPEND PROPERTY IMPORTED_LOCATION "${MANIFOLD_LIBRARY}")
    endif()
  endif()
endif()
