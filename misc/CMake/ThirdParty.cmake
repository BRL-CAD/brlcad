...
MACRO(THIRD_PARTY lower dir)
	...
	FOREACH(extraarg ${ARGN})
		IF(extraarg STREQUAL "NOSYS")
			IF(${CMAKE_PROJECT_NAME}_${upper} STREQUAL "BUNDLED (SYSTEM)")
				SET(${CMAKE_PROJECT_NAME}_${upper} "AUTO" CACHE STRING "NOSYS passed - striped system flag from AUTO" FORCE)
			ENDIF(${CMAKE_PROJECT_NAME}_${upper} STREQUAL "BUNDLED (SYSTEM)")
	...
	ELSE(${CMAKE_PROJECT_NAME}_${upper} STREQUAL "BUNDLED" OR ${CMAKE_PROJECT_NAME}_${upper} STREQUAL "BUNDLED (AUTO)")
		...
		IF(NOT ${upper}_FOUND AND NOT ${CMAKE_PROJECT_NAME}_${upper} STREQUAL "SYSTEM" AND NOT ${CMAKE_PROJECT_NAME}_${upper} STREQUAL "BUNDLED (SYSTEM)")
			SET(${CMAKE_PROJECT_NAME}_${upper}_BUILD ON)
			SET(${upper}_LIBRARY "${lower}" CACHE STRING "set by THIRD_PARTY macro" FORCE)
		ELSE(NOT ${upper}_FOUND AND NOT ${CMAKE_PROJECT_NAME}_${upper} STREQUAL "SYSTEM" AND NOT ${CMAKE_PROJECT_NAME}_${upper} STREQUAL "BUNDLED (SYSTEM)")
			SET(${upper}_FOUND "TRUE" CACHE STRING "${upper}_FOUND" FORCE)
		ENDIF(NOT ${upper}_FOUND AND NOT ${CMAKE_PROJECT_NAME}_${upper} STREQUAL "SYSTEM" AND NOT ${CMAKE_PROJECT_NAME}_${upper} STREQUAL "BUNDLED (SYSTEM)")
		IF(${upper}_FOUND)
