...
MACRO(THIRD_PARTY_SUBDIR upper lower)
	IF(${CMAKE_PROJECT_NAME}_BUILD_LOCAL_${upper} AND NOT ${CMAKE_PROJECT_NAME}-ENABLE_SYSTEM_LIBS_ONLY)
		...
		IF(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/dlists/${lower}.dist)
			FILE(STRINGS ${CMAKE_CURRENT_SOURCE_DIR}/dlists/${lower}.dist ${lower}_ignore_files)
			DISTCHECK_IGNORE(${lower} ${lower}_ignore_files)
		ELSE(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/dlists/${lower}.dist)
			MESSAGE("Local build, but file ${CMAKE_CURRENT_SOURCE_DIR}/dlists/${lower}.dist not found")
		ENDIF(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/dlists/${lower}.dist)
