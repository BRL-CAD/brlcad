...
SET(SCL_VARLIST "SCL_EXPRESS_EXECUTABLE;SCL_SYMLINK_EXECUTABLE;SCL_EXPPP_EXECUTABLE;SCL_FEDEX_OS_EXECUTABLE;SCL_FEDEX_IDL_EXECUTABLE;SCL_FEDEX_PLUS_EXECUTABLE;SCL_EXPPP_LIB;SCL_CORE_LIB;SCL_DAI_LIB;SCL_UTILS_LIB;SCL_EDITOR_LIB")

FOREACH(sclvar ${SCL_VARLIST})
	FOREACH(pattern ${SCL_PATH_NOMATCH_PATTERNS})
		IF(${sclvar} MATCHES "${pattern}")
			SET(${sclvar} "${sclvar}-NOTFOUND" CACHE STRING "Set by FindSCL" FORCE)
		ENDIF(${sclvar} MATCHES "${pattern}")
	ENDFOREACH(pattern ${SCL_PATH_NOMATCH_PATTERNS})
ENDFOREACH(sclvar ${SCL_VARLIST})
