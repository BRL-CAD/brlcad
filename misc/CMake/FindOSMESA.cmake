...
if(OSMESA_FOUND)
  ...
  if(NOT TARGET OSMESA::OSMESA)
    ...
    set_target_properties(OSMESA::OSMESA PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${OSMESA_INCLUDE_DIRS}")

    if(OSMESA_LIBRARY_RELEASE)
      set_property(TARGET OSMESA::OSMESA APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
      set_target_properties(OSMESA::OSMESA PROPERTIES IMPORTED_LOCATION_RELEASE "${OSMESA_LIBRARY_RELEASE}")
    endif()

    if(OSMESA_LIBRARY_DEBUG)
      set_property(TARGET OSMESA::OSMESA APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
      set_target_properties(OSMESA::OSMESA PROPERTIES IMPORTED_LOCATION_DEBUG "${OSMESA_LIBRARY_DEBUG}")
    endif()

    if(NOT OSMESA_LIBRARY_RELEASE AND NOT OSMESA_LIBRARY_DEBUG)
      set_property(TARGET OSMESA::OSMESA APPEND PROPERTY IMPORTED_LOCATION "${OSMESA_LIBRARY}")
    endif()
  endif()
endif()
