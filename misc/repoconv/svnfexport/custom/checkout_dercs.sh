#!/bin/bash
find . -type f ! -path "*/misc/*" ! -path "*/src/other/stepcode/*" ! -path "*/src/conv/step/*" ! -path "*/ap242.exp" -exec sed -i 's/$Date:[^$;"]*/$Date/' {} \;
find . -type f ! -path "*/misc/*" ! -path "*/src/other/stepcode/*" ! -path "*/src/conv/step/*" ! -path "*/ap242.exp" -exec sed -i 's/$Header:[^$;"]*/$Header/' {} \;
find . -type f ! -path "*/misc/*" ! -path "*/src/other/stepcode/*" ! -path "*/src/conv/step/*" ! -path "*/ap242.exp" -exec sed -i 's/$Id:[^$;"]*/$Id/' {} \;
find . -type f ! -path "*/misc/*" ! -path "*/src/other/stepcode/*" ! -path "*/src/conv/step/*" ! -path "*/ap242.exp" -exec sed -i 's/$Log:[^$;"]*/$Log/' {} \;
find . -type f ! -path "*/misc/*" ! -path "*/src/other/stepcode/*" ! -path "*/src/conv/step/*" ! -path "*/ap242.exp" -exec sed -i 's/$Revision:[^$;"]*/$Revision/' {} \;
find . -type f ! -path "*/misc/*" ! -path "*/src/other/stepcode/*" ! -path "*/src/conv/step/*" ! -path "*/ap242.exp" -exec sed -i 's/$Source:[^$;"]*/$Source/' {} \;
