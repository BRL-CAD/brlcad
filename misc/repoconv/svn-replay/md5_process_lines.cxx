 ...
 *
 * Specific original use case was generating md5 sums of commit messages to pair
 * with commit ids for easy matching between commit lists from subversion and git:
 *
...
awk -F',' '{$1=""; $2=""; $3=""; print $0}' brlcad_log.csv|sed -e 's/^[ \t]*//' > svn_msgs.txt
