 ...
 * being used. */
BV_EXPORT extern int bv_snap_lines_2d(struct bview *v, struct bu_ptbl *sobjs, fastf_t *fx, fastf_t *fy);

BV_EXPORT extern void bv_view_center_linesnap(struct bview *v, struct bu_ptbl *sobjs);

BV_EXPORT extern int bv_snap_lines_3d(point_t *out_pt, struct bview *v, struct bu_ptbl *sobjs, point_t *p);
