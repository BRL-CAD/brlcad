 ...
 *
 * @brief
 * libmultispectral is mostly a result of applying different compilation flags
 * to liboptical.
 *
 * spectrum.h contains data structures to assist with recording spectral data.
 * The overall notion is that each spectral sample should be as compact as
 * possible (typically just an array of power levels), with all the context
 * stored in one place.
 *
