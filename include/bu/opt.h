 ...
 *
 * bu_opt is the succinct option-only interface to libbu's command parsing
 * engine.  Commands that also need typed operands, completion, declarative
 * constraints or ranges, linting, or JSON publication should use the full
 * bu_cmd_schema API in bu/cmdschema.h.
 *
