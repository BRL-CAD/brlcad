...
DM_EXPORT extern void dm_draw_viewobjs(struct rt_wdb *wdbp, struct bview *v, struct bu_ptbl *objs, struct dm_view_data *d);

/* Stripped down form of dm_draw_viewobjs that does just what's needed for the new setup */
DM_EXPORT extern void dm_draw_objs(struct bview *v, struct bu_ptbl *objs, void (*dm_draw_custom)(struct bview *, struct bu_ptbl *, void *), void *u_data);
#endif /* DM_NO_RT */
