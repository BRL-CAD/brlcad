...
BVIEW_EXPORT extern size_t bv_vlist_cmd_cnt(struct bv_vlist *vlist);
BVIEW_EXPORT extern int bv_vlist_bbox(struct bu_list *vlistp, point_t *bmin, point_t *bmax, size_t *length);
 ...
 *
 */
BVIEW_EXPORT extern void bv_vlist_3string(struct bu_list *vhead,
 ...
 *
 */
BVIEW_EXPORT extern void bv_vlist_2string(struct bu_list *vhead,
				       struct bu_list *free_hd,
				       const char *string,
				       double x,
				       double y,
 ...
 */
BVIEW_EXPORT extern const char *bv_vlist_get_cmd_description(int cmd);
 ...
 */
BVIEW_EXPORT extern size_t bv_ck_vlist(const struct bu_list *vhead);
 ...
 */
BVIEW_EXPORT extern void bv_vlist_copy(struct bu_list *vlists,
				    struct bu_list *dest,
 ...
 */
BVIEW_EXPORT extern void bv_vlist_export(struct bu_vls *vls,
				      struct bu_list *hp,
				      const char *name);
 ...
 */
BVIEW_EXPORT extern void bv_vlist_import(struct bu_list *vlists,
				      struct bu_list *hp,
				      struct bu_vls *namevls,
				      const unsigned char *buf);

BVIEW_EXPORT extern void bv_vlist_cleanup(struct bu_list *hd);

BVIEW_EXPORT extern struct bv_vlblock *bv_vlblock_init(struct bu_list *free_vlist_hd, /* where to get/put free vlists */
						    int max_ent);

BVIEW_EXPORT extern void bv_vlblock_free(struct bv_vlblock *vbp);

BVIEW_EXPORT extern struct bu_list *bv_vlblock_find(struct bv_vlblock *vbp,
						 int r,
						 int g,
						 int b);


BVIEW_EXPORT void bv_vlist_rpp(struct bu_list *vlists, struct bu_list *hd, const point_t minn, const point_t maxx);

/**
 * Output a bv_vlblock object in extended UNIX-plot format, including
 * color.
 */
BVIEW_EXPORT extern void bv_plot_vlblock(FILE *fp,
 ...
 * UNIX-Plot output.
 */
BVIEW_EXPORT extern void bv_vlist_to_uplot(FILE *fp,
