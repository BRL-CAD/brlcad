...
set mged_help_data(facetize)	{{[options] [old_obj1 | new_obj] [old_obj* ...] [old_objN | new_obj]}	{Convert objects to faceted BOT objects. See man page ("man facetize") for all usage and examples}}
