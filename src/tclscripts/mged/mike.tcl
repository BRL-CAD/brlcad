...
proc mike_dedication {id} {
    ...
    set mike_file [file join [bu_brlcad_root "share/tclscripts"] mged mike-tux.ppm]
    ...
    set dedi_file [file join [bu_brlcad_root "share/tclscripts"] mged mike-dedication.txt]
