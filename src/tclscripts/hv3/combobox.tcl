...
#     args     additional option/value pairs (e.g.: -background white, etc.)
#
# Results:
#
...
#    arguments intact.
#
#    Note that some widget commands are defined "inline" (i.e.:
...
proc ::combobox::WidgetProc {w command args} {
	...
	# directly (e.g.: listinsert, listdelete), but we
...
proc ::combobox::Configure {w args} {
    ...
    # to deal with backwards compatibility (i.e.: tk 8.3 and below
...
proc ::combobox::SetValue {w newValue} {
    ...
    # textvariable (i.e.: defined by the user) to be updated as
    # well
