...
int
bg_2d_chull(point2d_t **hull, const point2d_t *points_2d, int n)
{
    int i = 0;
    int retval = 0;
    ...
    retval = bg_polyline_2d_chull(hull, const_points, n);
...
int
bg_3d_coplanar_chull(point_t **hull, const point_t *points_3d, int n)
{
    int ret = 0;
    int hull_cnt = 0;
    point_t origin_pnt;
