...
main(int argc, const char **argv)
{
	...
	retval = bg_polyline_2d_chull(&hull_polyline, (const point2d_t *)test1_points, n);
	if (!retval) return -1;
	...
	retval = bg_3d_coplanar_chull(&test3_hull_pnts, (const point_t *)test3_points, 17);
	...
	retval = bg_3d_coplanar_chull(&test4_hull_pnts, (const point_t *)test4_points, 17);
	...
	retval = bg_3d_coplanar_chull(&test5_hull_pnts, (const point_t *)test5_points, 9);
