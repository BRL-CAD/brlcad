...
QgModel::refresh()
{
    ...
    // TODO - beginning to wonder if the QgItem concept should be fully defined
    // at the SelectionProxy level, leaving the QgModel to manage just the
    // gInstances.  Conceptually QgItems only make sense at a higher level...
