...
BRLCAD_MainWindow::BRLCAD_MainWindow(int canvas_type, int quad_view)
{
    ...
    treemodel = new QgSelectionProxyModel();
    QgModel *m = new QgModel();
    treemodel->setSourceModel(m);
    treeview = new QgTreeView(tree_dock, treemodel);
    ...
    connect(vc, &CADPalette::interaction_mode, treemodel, &QgSelectionProxyModel::mode_change);
    connect(ic, &CADPalette::interaction_mode, treemodel, &QgSelectionProxyModel::mode_change);
    connect(oc, &CADPalette::interaction_mode, treemodel, &QgSelectionProxyModel::mode_change);
    ...
    // removed solids too...)
    QObject::connect((CADApp *)qApp, &CADApp::app_changed_db, treemodel, &QgSelectionProxyModel::refresh);
