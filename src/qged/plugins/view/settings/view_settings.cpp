...
view_settings_tool_create()
{
    ...
    QObject::connect(el, &QToolPaletteElement::view_changed, vs, &CADViewSettings::checkbox_refresh);
    QObject::connect(vs, &CADViewSettings::settings_changed, el, &QToolPaletteElement::do_view_update);
