...
polygon_tool_create()
{
    ...
    QObject::connect(poly_create, &QPolyCreate::db_updated, el, &QToolPaletteElement::do_gui_changed_db);
...
polygon_tool_modify()
{
    ...
    QObject::connect(poly_mod, &QPolyMod::db_updated, el, &QToolPaletteElement::do_gui_changed_db);
