...
int ReadArgs(int argc, char **argv, fastf_t *isoarray, struct bu_vls *name, struct bu_vls *dimens, int *gen_name, int *add_tread, int *number_of_tread_patterns, int *tread_depth)
{
    int c = 0;
    char *options="d:n:c:g:ath";
    int d1, d2, d3;
    int count;
    int treadep;
