# For COMMAND bu_test test_vls, the input format is as follows:
#
# COMMAND bu_test test_vls <function number> <args>

# For function #1 (bu_vls_init) there are no arguments
add_test(NAME bu_vls_init COMMAND bu_test test_vls 1)

# For function #2 (bu_vls_vlsinit) there are no arguments
add_test(NAME bu_vls_vlsinit COMMAND bu_test test_vls 2)
...
add_test(NAME bu_vls_access_1 COMMAND bu_test test_vls 3 "Test 1 2 3")
...
add_test(
  ...
  COMMAND bu_test test_vls 4 "Test 1" "Test 1 2" 4 "Test"
)
add_test(
  NAME bu_vls_strncpy_2
  COMMAND bu_test test_vls 4 "Test 1" "Test 1 2" 8 "Test 1 2"
)
...
add_test(NAME bu_vls_strdup_1 COMMAND bu_test test_vls 5 "Test 1 2 3")
...
add_test(NAME bu_vls_strlen_1 COMMAND bu_test test_vls 6 "Test 1 2 3")
...
add_test(
  NAME bu_vls_trunc_1
  COMMAND bu_test test_vls 7 "Test 1 2 3" 6 "Test 1"
)
add_test(
  NAME bu_vls_trunc_2
  COMMAND bu_test test_vls 7 "Test 1 2 3" -2 "Test 1 2"
)
...
add_test(
  ...
  COMMAND bu_test test_vls 9 "Test 1 2 3" 4 " 1 2 3"
)
...
add_test(
  ...
  COMMAND bu_test test_vls 10 "Test 1" " 2 3" "Test 1 2 3"
)
...
add_test(
  ...
  COMMAND bu_test test_vls 11 "Test 1" " 2 3" 4 "Test 1 2 3"
)
add_test(
  NAME bu_vls_strncat_2
  COMMAND bu_test test_vls 11 "Test 1" " 2 3" 2 "Test 1 2"
)
add_test(
...
add_test(
  ...
  COMMAND bu_test test_vls 11 "Test 1" " 2 3" 0 "Test 1"
)
add_test(
  NAME bu_vls_strncat_5
  COMMAND bu_test test_vls 11 "Test 1" " 2 3" 5 "Test 1 2 3"
)
...
add_test(
  ...
  COMMAND bu_test test_vls 12 "Test 1" " 2 3" "Test 1 2 3"
)
...
add_test(
  ...
  COMMAND bu_test test_vls 13 "Test 1" "Test 1" 0
)
add_test(
  NAME bu_vls_strcmp_lesser_1
  COMMAND bu_test test_vls 13 "Test 1" "Test 2" -1
)
add_test(
  NAME bu_vls_strcmp_greater_1
  COMMAND bu_test test_vls 13 "Test 1" "Test 0" 1
)
...
add_test(
  ...
  COMMAND bu_test test_vls 14 "Test 1" "Test 1" 6 0
)
add_test(
  NAME bu_vls_strncmp_lesser_1
  COMMAND bu_test test_vls 14 "Test 1" "Test 2" 6 -1
)
add_test(
  NAME bu_vls_strncmp_greater_1
  COMMAND bu_test test_vls 14 "Test 1" "Test 0" 6 1
)
add_test(
  NAME bu_vls_strncmp_equal_2
  COMMAND bu_test test_vls 14 "Test 1" "Test 1" 4 0
)
add_test(
  NAME bu_vls_strncmp_equal_3
  COMMAND bu_test test_vls 14 "Test 1" "Test 2" 4 0
)
add_test(
  NAME bu_vls_strncmp_equal_4
  COMMAND bu_test test_vls 14 "Test 1" "Test 0" 4 0
)
...
add_test(
  ...
  COMMAND bu_test test_vls 15 Test Test 2 3 4 "Test Test 2 3 4"
)
...
add_test(
  ...
  COMMAND bu_test test_vls 16 "   Testing1 2   " "Testing1 2"
)
...
add_test(
  ...
  COMMAND bu_test test_vls 17 "Testing1 2" 3 "Testing1 2   "
)
...
add_test(
  NAME bu_vls_detab_1
  COMMAND bu_test test_vls 18 "Testing	1 2	3" "Testing 1 2     3"
)
...
add_test(
  ...
  COMMAND bu_test test_vls 19 "2 3" "Test 1 " "Test 1 2 3"
)
...
add_test(
  ...
  COMMAND bu_test test_vls 20 "01234567890" 0 5 "01234"
)
add_test(
  NAME bu_vls_substr_02
  COMMAND bu_test test_vls 20 "01234567890" -2 5 ""
)
add_test(
  NAME bu_vls_substr_03
  COMMAND bu_test test_vls 20 "01234567890" -2 20 ""
)
add_test(
  NAME bu_vls_substr_04
  COMMAND bu_test test_vls 20 "01234567890" 5 20 "567890"
)
add_test(
  NAME bu_vls_substr_05
  COMMAND bu_test test_vls 20 "01234567890" 0 20 "01234567890"
)
add_test(
  NAME bu_vls_substr_06
  COMMAND bu_test test_vls 20 "01234567890" 2 5 "23456"
)
add_test(
  NAME bu_vls_substr_07
  COMMAND bu_test test_vls 20 "01234567890" 20 5 ""
)
add_test(
  NAME bu_vls_substr_08
  COMMAND bu_test test_vls 20 "01234567890" 0 -1 "01234567890"
)
add_test(
  NAME bu_vls_substr_09
  COMMAND bu_test test_vls 20 "01234567890" 2 -1 "234567890"
)
add_test(
  NAME bu_vls_substr_10
  COMMAND bu_test test_vls 20 "01234567890" 0 0 ""
)
add_test(
  NAME bu_vls_substr_11
  COMMAND bu_test test_vls 20 "01234567890" 0 2 "01"
)
add_test(
  NAME bu_vls_substr_12
  COMMAND bu_test test_vls 20 "01234567890" 11 20 ""
)
