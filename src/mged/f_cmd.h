...
extern int f_be_s_xscale(ClientData, Tcl_Interp *, int, const char *[]);
extern int f_be_s_yscale(ClientData, Tcl_Interp *, int, const char *[]);
extern int f_be_s_zscale(ClientData, Tcl_Interp *, int, const char *[]);
