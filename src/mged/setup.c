...
static struct cmdtab mged_cmdtab[] = {
    ...
    {MGED_CMD_MAGIC, "pix2fb", cmd_ged_dm_wrapper, ged_exec_pix2fb, NULL},
    ...
    {MGED_CMD_MAGIC, "png2fb", cmd_ged_dm_wrapper, ged_exec_png2fb, NULL},
    ...
    {MGED_CMD_MAGIC, "sxscale", f_be_s_xscale, GED_FUNC_PTR_NULL, NULL},
    {MGED_CMD_MAGIC, "sxy", f_be_s_trans, GED_FUNC_PTR_NULL, NULL},
    {MGED_CMD_MAGIC, "syscale", f_be_s_yscale, GED_FUNC_PTR_NULL, NULL},
    {MGED_CMD_MAGIC, "szscale", f_be_s_zscale, GED_FUNC_PTR_NULL, NULL},
