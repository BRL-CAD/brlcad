...
static struct cmdtab cmdtab[] = {
    ...
    {"clone", f_clone, GED_FUNC_PTR_NULL},
    ...
    {"copymat", f_copymat, GED_FUNC_PTR_NULL},
    ...
    {"decompose", f_decompose, GED_FUNC_PTR_NULL},
    {"delay", f_delay, GED_FUNC_PTR_NULL},
    ...
    {"eac", f_eac, GED_FUNC_PTR_NULL},
    {"echo", cmd_ged_plain_wrapper, ged_echo},
    {"edcodes", f_edcodes, GED_FUNC_PTR_NULL},
    {"edcolor", f_edcolor, GED_FUNC_PTR_NULL}, /* XXX kill this */
    ...
    {"facetize", f_facetize, GED_FUNC_PTR_NULL},
    ...
    {"get_comb", cmd_get_comb, GED_FUNC_PTR_NULL},
    {"get_dbip", cmd_get_ptr, GED_FUNC_PTR_NULL},
    ...
    {"idents", f_tables, GED_FUNC_PTR_NULL},
    {"ill", f_ill, GED_FUNC_PTR_NULL},
    {"in", f_in, GED_FUNC_PTR_NULL},
    {"inside", f_inside, GED_FUNC_PTR_NULL},
    ...
    {"kill", cmd_kill, GED_FUNC_PTR_NULL},
    {"killall", cmd_killall, GED_FUNC_PTR_NULL},
    {"killrefs", cmd_killrefs, GED_FUNC_PTR_NULL},
    {"killtree", cmd_killtree, GED_FUNC_PTR_NULL},
    ...
    {"loadview", f_loadview, GED_FUNC_PTR_NULL},
    ...
    {"rcodes", f_rcodes, GED_FUNC_PTR_NULL},
    ...
    {"regions", f_tables, GED_FUNC_PTR_NULL},
    ...
    {"rtabort", cmd_rtabort, GED_FUNC_PTR_NULL},
    ...
    {"savekey", f_savekey, GED_FUNC_PTR_NULL},
    {"saveview", f_saveview, GED_FUNC_PTR_NULL},
    ...
    {"solids", f_tables, GED_FUNC_PTR_NULL},
    {"solids_on_ray", cmd_solids_on_ray, GED_FUNC_PTR_NULL},
