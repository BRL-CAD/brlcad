...
set(mged_work_db "${CMAKE_CURRENT_BINARY_DIR}/mged_cmd_complete.g")
file(COPY_FILE "${DB_FILE}" "${mged_work_db}")

execute_process(
  COMMAND "${MGED_EXECUTABLE}" -c "${mged_work_db}"
...
foreach(expected_tcl_completion
    "utf8-path:1 {draw tör.r} tör.r 1 10"
    "escaped-path:1 {draw all.g\\/tor.r rest} tor.r 1 17"
    "quoted-escaped-path:1 {draw \"all.g\\/tor.r\" rest} tor.r 1 18"
    "escaped-space:1"
    "quoted-escaped-space:1"
    "escaped-backslash:1"
    "mid-token-suffix:1"
...
foreach(expected_layout
    ...
    "layout-multiline:1"
    "gui-completion-inline-resize:1")
