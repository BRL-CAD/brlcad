...
const struct mged_functab MGED_OBJ[] = {
	...
	NULL,  /* label */
	MGEDFUNCTAB_FUNC_KEYPOINT_CAST(mged_generic_keypoint), /* keypoint */
	MGEDFUNCTAB_FUNC_E_AXES_POS_CAST(mged_tgc_e_axes_pos), /* s->e_axes_pos */
	...
	MGEDFUNCTAB_FUNC_E_AXES_POS_CAST(mged_arb_e_axes_pos), /* s->e_axes_pos */
	...
	MGEDFUNCTAB_FUNC_E_AXES_POS_CAST(mged_extrude_e_axes_pos), /* s->e_axes_pos */
	NULL,  /* write_params */
	NULL,  /* read_params */
	...
	NULL,  /* label */
	MGEDFUNCTAB_FUNC_KEYPOINT_CAST(mged_generic_keypoint),   /* keypoint */
	MGEDFUNCTAB_FUNC_E_AXES_POS_CAST(mged_cline_e_axes_pos), /* s->e_axes_pos */
	NULL,  /* write_params */
	NULL,  /* read_params */
