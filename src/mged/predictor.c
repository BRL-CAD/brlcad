...
predictor_frame(void)
{
    ...
    /* Draw the trails */
    poly_trail(&trail, &mged_curr_dm->dml_trails[0], &mged_curr_dm->dml_trails[4]);
    BU_LIST_APPEND_LIST(&mged_curr_dm->dml_p_vlist, &trail);
    poly_trail(&trail, &mged_curr_dm->dml_trails[1], &mged_curr_dm->dml_trails[5]);
    BU_LIST_APPEND_LIST(&mged_curr_dm->dml_p_vlist, &trail);
    poly_trail(&trail, &mged_curr_dm->dml_trails[6], &mged_curr_dm->dml_trails[2]);
    BU_LIST_APPEND_LIST(&mged_curr_dm->dml_p_vlist, &trail);
    poly_trail(&trail, &mged_curr_dm->dml_trails[7], &mged_curr_dm->dml_trails[3]);
    BU_LIST_APPEND_LIST(&mged_curr_dm->dml_p_vlist, &trail);
