...
int
wgl_is_listening(struct fbserv_obj *fbsp)
{
#if defined(_WIN32) && !defined(__CYGWIN__)
...
int
wgl_listen_on_port(struct fbserv_obj *fbsp, int available_port)
{
    char hostname[32] = {0};
...
void
wgl_open_server_handler(struct fbserv_obj *fbsp)
{
#if defined(_WIN32) && !defined(__CYGWIN__)
...
void
wgl_close_server_handler(struct fbserv_obj *fbsp)
{
#if defined(_WIN32) && !defined(__CYGWIN__)
    if (fbsp->fbs_listener.fbsl_chan != NULL) {
...
void
#if defined(_WIN32) && !defined(__CYGWIN__)
wgl_open_client_handler(struct fbserv_obj *fbsp, int i, void *data)
#else
wgl_open_client_handler(struct fbserv_obj *fbsp, int i, void *UNUSED(data))
#endif
{
#if defined(_WIN32) && !defined(__CYGWIN__)
...
void
wgl_close_client_handler(struct fbserv_obj *fbsp, int sub)
{
#if defined(_WIN32) && !defined(__CYGWIN__)
