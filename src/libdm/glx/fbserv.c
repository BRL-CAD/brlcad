...
int
ogl_is_listening(struct fbserv_obj *fbsp)
{
#if defined(_WIN32) && !defined(__CYGWIN__)
...
int
ogl_listen_on_port(struct fbserv_obj *fbsp, int available_port)
{
    char hostname[32] = {0};
...
void
ogl_open_server_handler(struct fbserv_obj *fbsp)
{
#if defined(_WIN32) && !defined(__CYGWIN__)
...
void
ogl_close_server_handler(struct fbserv_obj *fbsp)
{
#if defined(_WIN32) && !defined(__CYGWIN__)
    if (fbsp->fbs_listener.fbsl_chan != NULL) {
...
void
#if defined(_WIN32) && !defined(__CYGWIN__)
ogl_open_client_handler(struct fbserv_obj *fbsp, int i, void *data)
#else
ogl_open_client_handler(struct fbserv_obj *fbsp, int i, void *UNUSED(data))
#endif
{
#if defined(_WIN32) && !defined(__CYGWIN__)
...
void
ogl_close_client_handler(struct fbserv_obj *fbsp, int sub)
{
#if defined(_WIN32) && !defined(__CYGWIN__)
