...
/*
    ...
    borderright = Tk_InternalBorderRight(Tk_Parent(((struct dm_xvars *)dmp->dm_vars.pub_vars)->xtkwin));
    bordertop = Tk_InternalBorderTop(Tk_Parent(((struct dm_xvars *)dmp->dm_vars.pub_vars)->xtkwin));
...
togl_open(Tcl_Interp *interp, int argc, char **argv)
{
    ...
    *dmp = dm_togl; /* struct copy */
    ...
    bu_vls_sprintf(&tclcmd, "bind %s.togl <KeyPress> {event generate %s <KeyPress> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
     bu_vls_sprintf(&tclcmd, "bind %s.togl <KeyRelease> {event generate %s <KeyRelease> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));


    bu_vls_sprintf(&tclcmd, "bind %s.togl <Motion> {event generate %s <Motion> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <ButtonRelease> {event generate %s <ButtonRelease> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <ButtonPress-1> {event generate %s <ButtonPress-1> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <ButtonPress-2> {event generate %s <ButtonPress-2> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <ButtonPress-3> {event generate %s <ButtonPress-3> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Shift-ButtonPress-1> {event generate %s <Shift-ButtonPress-1> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Shift-ButtonPress-2> {event generate %s <Shift-ButtonPress-2> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Shift-ButtonPress-3> {event generate %s <Shift-ButtonPress-3> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Control-ButtonPress-1> {event generate %s <Control-ButtonPress-1> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Control-ButtonPress-2> {event generate %s <Control-ButtonPress-2> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Control-ButtonPress-3> {event generate %s <Control-ButtonPress-3> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Shift-Control-ButtonPress-1> {event generate %s <Shift-control-ButtonPress-1> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Shift-Control-ButtonPress-2> {event generate %s <Shift-control-ButtonPress-2> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Shift-Control-ButtonPress-3> {event generate %s <Shift-control-ButtonPress-3> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Shift-Control-ButtonPress-1> {event generate %s <Shift-Control-ButtonPress-1> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Shift-Control-ButtonPress-2> {event generate %s <Shift-Control-ButtonPress-2> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    ...
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Shift-Control-ButtonPress-3> {event generate %s <Shift-Control-ButtonPress-3> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Alt-Shift-ButtonPress-1> {event generate %s <Alt-Shift-ButtonPress-1> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Alt-Shift-ButtonPress-2> {event generate %s <Alt-Shift-ButtonPress-2> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Alt-Shift-ButtonPress-3> {event generate %s <Alt-Shift-ButtonPress-3> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Alt-Control-ButtonPress-1> {event generate %s <Alt-Control-ButtonPress-1> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Alt-Control-ButtonPress-2> {event generate %s <Alt-Control-ButtonPress-2> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Alt-Control-ButtonPress-3> {event generate %s <Alt-Control-ButtonPress-3> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Alt-Shift-Control-ButtonPress-1> {event generate %s <Alt-Shift-Control-ButtonPress-1> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Alt-Shift-Control-ButtonPress-2> {event generate %s <Alt-Shift-Control-ButtonPress-2> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
    bu_vls_sprintf(&tclcmd, "bind %s.togl <Alt-Shift-Control-ButtonPress-3> {event generate %s <Alt-Shift-Control-ButtonPress-3> -x %%x -y %%y -warp 1}", (char *)Tk_PathName(pubvars->xtkwin), (char *)Tk_PathName(pubvars->xtkwin));
    Tcl_Eval(interp,  bu_vls_addr(&tclcmd));
