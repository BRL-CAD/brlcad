...
DMGL_EXPORT extern int gl_drawVList(struct dm *dmp, struct bn_vlist *vp);
DMGL_EXPORT extern int gl_drawVListHiddenLine(struct dm *dmp, struct bn_vlist *vp);
DMGL_EXPORT extern int gl_draw_data_axes(struct dm *dmp, fastf_t sf,  struct bview_data_axes_state *bndasp);
DMGL_EXPORT extern int gl_draw_obj(struct dm *dmp, struct display_list *obj);
...
DMGL_EXPORT extern int gl_normal(struct dm *dmp);
