...
BU_EXPORT BU_EXTERN(void texture_checker_init, (struct texture_s *texture, int checker));
BU_EXPORT BU_EXTERN(void texture_checker_free, (struct texture_s *texture));
...
BU_EXPORT BU_EXTERN(void texture_gradient_init, (struct texture_s *texture, int axis));
BU_EXPORT BU_EXTERN(void texture_gradient_free, (struct texture_s *texture));
...
BU_EXPORT BU_EXTERN(void texture_image_init, (struct texture_s *texture, short w, short h, unsigned char *image));
BU_EXPORT BU_EXTERN(void texture_image_free, (struct texture_s *texture));
...
BU_EXPORT BU_EXTERN(void texture_stack_init, (struct texture_s *texture));
BU_EXPORT BU_EXTERN(void texture_stack_free, (struct texture_s *texture));
BU_EXPORT BU_EXTERN(void texture_stack_work, (__TEXTURE_WORK_PROTOTYPE__));
BU_EXPORT BU_EXTERN(void texture_stack_push, (struct texture_s *texture, struct texture_s *texture_new));
