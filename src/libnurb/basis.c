 ...
 */
fastf_t
nurb_basis_eval(register struct knot_vector *knts, int interval, int order, fastf_t mu)
{
	...
	b1 = ((mu - k1) *
	      nurb_basis_eval(knts, interval, order - 1, mu)) / den;
	...
	b2 = ((k3 - mu) *
	      nurb_basis_eval(knts, interval + 1, order - 1, mu)) / den;
