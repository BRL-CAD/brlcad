...
struct bu_structparse view_parse[] = {
    ...
    {"%f", 3, "foreground", bu_byteoffset(float_fgcolor[0]), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL},
    {"%f", 3, "fg", bu_byteoffset(float_fgcolor[0]), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL},
