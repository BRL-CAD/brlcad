...
if (BRLCAD_ZLIB_BUILD)
  ...
  ExternalProject_Add(ZLIB_BLD
    ...
    CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR}/zlib -DLIB_DIR=${LIB_DIR} -DBIN_DIR=${BIN_DIR}
  ...
  ExternalProject_Target(zlib ZLIB_BLD ${CMAKE_BINARY_DIR}/zlib
    ...
    SYMLINKS "${LIB_DIR}/${ZLIB_BASENAME}${CMAKE_SHARED_LIBRARY_SUFFIX};${LIB_DIR}/${ZLIB_BASENAME}${CMAKE_SHARED_LIBRARY_SUFFIX}.1"
    LINK_TARGET "${ZLIB_BASENAME}${CMAKE_SHARED_LIBRARY_SUFFIX}"
    RPATH
    )
  ExternalProject_ByProducts(zlib ZLIB_BLD ${CMAKE_BINARY_DIR}/zlib ${INCLUDE_DIR} ${INCLUDE_DIR}
    zconf.h
    zlib.h
    )
