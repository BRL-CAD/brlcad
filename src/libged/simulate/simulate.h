...
struct rigid_body {
    ...
    /* Manifold generated by Bullet, where this body is B, only body B has manifold info, used to DEBUG */
    int num_bt_manifolds;			 /**< @brief number of manifold for this body as reported by Bullet */
    struct sim_manifold *bt_manifold;/**< @brief head of the manifolds linked list as got from Bullet*/

    /* The manifolds got by raytracing: this is the core of the simulation */
    int num_rt_manifolds;			  /**< @brief number of manifold for this body as got by rt */
    struct sim_manifold *rt_manifold; /**< @brief head of the manifolds linked list as got by rt */
};
