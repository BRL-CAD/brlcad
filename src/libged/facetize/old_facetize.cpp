...
static void
old_facetize_show_schema_help(struct ged *gedp)
{
    char *help = bu_cmd_schema_help(old_facetize_schema(), "facetize_old");
...
ged_facetize_old_core(struct ged *gedp, int argc, const char *argv[])
{
	...
	old_facetize_show_schema_help(gedp);
...
static const char * const old_facetize_b_mode[] = {"B", NULL};
static const char * const old_facetize_b_options[] = {"B", "threshold", NULL};
static const char * const old_facetize_in_place_modes[] = {
    "in-place", "resume", NULL
};
static const char * const old_facetize_output_modes[] = {
    "B", "in-place", "resume", NULL
};
static const struct bu_cmd_constraint old_facetize_constraints[] = {
    BU_CMD_CONSTRAINT_OPTIONS_IF(BU_CMD_CONDITION_ANY_OPTION_PRESENT,
	old_facetize_b_options, 2, 2,
	"-B and --threshold must be specified together"),
    BU_CMD_CONSTRAINT_OPERANDS(BU_CMD_CONDITION_ANY_OPTION_PRESENT,
	old_facetize_b_mode, 2, 2,
	"BREP mode requires one input and one output object"),
    BU_CMD_CONSTRAINT_OPERANDS(BU_CMD_CONDITION_ANY_OPTION_PRESENT,
	old_facetize_in_place_modes, 1, BU_CMD_COUNT_UNLIMITED,
	"In-place and resume modes require at least one object"),
    BU_CMD_CONSTRAINT_OPERANDS(BU_CMD_CONDITION_NO_OPTION_PRESENT,
	old_facetize_output_modes, 2, BU_CMD_COUNT_UNLIMITED,
	"Standard mode requires input geometry and an output object"),
...
static const struct bu_cmd_schema old_facetize_cmd_schema = {
    ...
    BU_CMD_SCHEMA_CONSTRAINTS(NULL, old_facetize_constraints)
};
