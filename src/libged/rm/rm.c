...
{
    char *help = bu_cmd_schema_help(&rm_cmd_schema, "rm");

    if (help) {
	bu_vls_sprintf(gedp->ged_result_str, "%s", help);
	bu_free(help, "rm native schema help");
    }
}
