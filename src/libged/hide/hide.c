...
GED_DEFINE_TYPED_OPERAND_SCHEMA_PROVIDER(hide, "hide",
    "Hide database objects from ordinary listings", "objects", BU_CMD_VALUE_STRING,
    1, BU_CMD_COUNT_UNLIMITED, "Database objects to hide", "ged.db_object_any");
...
ged_hide_core(struct ged *gedp, int argc, const char *argv[])
{
    ...
    operand_index = bu_cmd_schema_parse_complete(&hide_cmd_schema, &parse_dummy,
