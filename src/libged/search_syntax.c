...
static const struct ged_search_top_option search_top_options[] = {
    {"-a", GED_SEARCH_TOP_OPTION_HIDDEN, "Include hidden database objects"},
    {"-Q", GED_SEARCH_TOP_OPTION_QUIET, "Suppress search diagnostics"},
    {"-h", GED_SEARCH_TOP_OPTION_HELP, "Print command help"},
    {"-?", GED_SEARCH_TOP_OPTION_HELP, "Print command help"},
    {"-v", GED_SEARCH_TOP_OPTION_VERBOSE,
	"Increase output detail; repeat up to three levels"}
};
