...
GED_DEFINE_TYPED_OPERAND_SCHEMA_POLICY_PROVIDER(set_output_script,
    "set_output_script", "Get or set the output handler script", "script",
    BU_CMD_VALUE_STRING, 0, 1, "Output handler script",
