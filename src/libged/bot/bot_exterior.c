...
ged_bot_exterior(struct ged *gedp, int argc, const char *argv[])
{
    ...
    GED_DB_LOOKUP(gedp, old_dp, argv[1], LOOKUP_NOISY, GED_ERROR & GED_QUIET);
    ...
    GED_DB_DIRADD(gedp, new_dp, argv[2], RT_DIR_PHONY_ADDR, 0, RT_DIR_SOLID, (void *)&intern.idb_type, GED_ERROR);
