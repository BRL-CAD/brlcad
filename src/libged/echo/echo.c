...
GED_DEFINE_TYPED_OPERAND_SCHEMA_POLICY_PROVIDER(echo, "echo",
    "Echo text to the command result", "text", BU_CMD_VALUE_RAW, 0,
    BU_CMD_COUNT_UNLIMITED, "Text to echo", BU_CMD_PARSE_OPTIONS_FIRST, NULL);
