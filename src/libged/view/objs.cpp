...
static int
ged_view_obj_msgs(void *bs, int argc, const char **argv,
...
_objs_cmd_draw(void *bs, int argc, const char **argv)
{
    ...
    if (ged_view_obj_msgs(bs, argc, argv, &ged_view_obj_draw_schema))
	return BRLCAD_OK;
...
_objs_cmd_delete(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (ged_view_obj_msgs(bs, argc, argv, &ged_view_obj_del_schema))
	return BRLCAD_OK;
...
_objs_cmd_color(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (ged_view_obj_msgs(bs, argc, argv, &ged_view_obj_color_schema))
	return BRLCAD_OK;
...
_objs_cmd_arrow(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (ged_view_obj_msgs(bs, argc, argv, &ged_view_obj_arrow_schema))
	return BRLCAD_OK;
...
_objs_cmd_lcnt(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (ged_view_obj_msgs(bs, argc, argv, &ged_view_obj_lcnt_schema))
	return BRLCAD_OK;
...
_objs_cmd_update(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (ged_view_obj_msgs(bs, argc, argv, &ged_view_obj_update_schema))
	return BRLCAD_OK;
    ...
    if (argc && (argc != 2)) {
	char *help = bu_cmd_schema_help(&ged_view_obj_update_schema,
	    "view obj object update");
	if (help) {
	    bu_vls_strcat(gedp->ged_result_str, help);
	    bu_free(help, "view object update help");
	}
	return BRLCAD_ERROR;
    }
...
{
    char *root_help = bu_cmd_schema_help(&ged_view_obj_schema, "view obj");
    char *child_help = bu_cmd_tree_help(&ged_view_obj_child_tree,
	"view obj object");

    if (root_help) {
	bu_vls_strcat(gedp->ged_result_str, root_help);
	bu_free(root_help, "view object native root help");
    }
    if (child_help) {
