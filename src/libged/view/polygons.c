...
polygon_set_validation(struct bu_cmd_validate_result *result,
    ...
    const char *hint)
{
    bu_cmd_validate_result_set(result, state, token, BU_CMD_EXPECT_OPERAND,
	value_type, hint, NULL);
}
...
GED_DEFINE_NO_ARG_SCHEMA_NAMED(polygon_clear_schema, "clear",
    "Clear polygon selection state", BU_CMD_PARSE_STOP_AT_FIRST_OPERAND);
...
GED_DEFINE_NO_ARG_SCHEMA_NAMED(polygon_area_schema, "area", "Report polygon area",
...
static const struct bu_cmd_schema polygon_fill_color_schema = {
    ...
    BU_CMD_PARSE_STOP_AT_FIRST_OPERAND,
    BU_CMD_SCHEMA_CONSTRAINTS(polygon_fill_color_validate, NULL)
};
...
_poly_cmd_create(void *bs, int argc, const char **argv)
{
    ...
    if (polygon_msgs(bs, argc, argv, &polygon_create_schema))
	return BRLCAD_OK;
...
_poly_cmd_select(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_select_schema))
	return BRLCAD_OK;
...
_poly_cmd_append(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_append_schema))
	return BRLCAD_OK;
...
_poly_cmd_move(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_move_schema))
	return BRLCAD_OK;
...
_poly_cmd_clear(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_clear_schema))
	return BRLCAD_OK;
...
_poly_cmd_close(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_close_schema))
	return BRLCAD_OK;
...
_poly_cmd_open(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_open_schema))
	return BRLCAD_OK;
...
_poly_cmd_area(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_area_schema))
	return BRLCAD_OK;
...
_poly_cmd_overlap(void *bs, int argc, const char **argv)
{
    ...
    if (polygon_msgs(bs, argc, argv, &polygon_overlap_schema))
	return BRLCAD_OK;
...
_poly_cmd_import(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_import_schema))
	return BRLCAD_OK;
...
_poly_cmd_export(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_export_schema))
	return BRLCAD_OK;
...
_poly_cmd_fill(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_fill_schema))
	return BRLCAD_OK;
...
_poly_cmd_fill_color(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_fill_color_schema))
	return BRLCAD_OK;
...
_poly_cmd_csg(void *bs, int argc, const char **argv)
{
    struct _ged_view_info *gd = (struct _ged_view_info *)bs;
    struct ged *gedp = gd->gedp;
    if (polygon_msgs(bs, argc, argv, &polygon_csg_schema))
	return BRLCAD_OK;
...
_view_cmd_polygons(void *bs, int argc, const char **argv)
{
	...
	char *help = bu_cmd_tree_help(&ged_view_polygon_tree,
	    "view obj <object> polygon");
	if (help) {
