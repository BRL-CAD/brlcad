...
static const struct bu_cmd_operand axes_xyz_optional_roles[] = {
    BU_CMD_OPERAND("x", BU_CMD_VALUE_NUMBER, 1, 1, "X coordinate", NULL),
    BU_CMD_OPERAND("y", BU_CMD_VALUE_NUMBER, 1, 1, "Y coordinate", NULL),
    BU_CMD_OPERAND("z", BU_CMD_VALUE_NUMBER, 1, 1, "Z coordinate", NULL),
    BU_CMD_OPERAND_NULL
};
static const struct bu_cmd_operand_group axes_xyz_optional_groups[] = {
    BU_CMD_OPERAND_GROUP("position", axes_xyz_optional_roles, 0, 1,
	"Optional XYZ position"),
...
static const struct bu_cmd_schema axes_pos_schema = {
    ...
    NULL, BU_CMD_PARSE_STOP_AT_FIRST_OPERAND,
	BU_CMD_SCHEMA_GROUPS(NULL, NULL, axes_xyz_optional_groups)
};
...
{
    char *help = bu_cmd_tree_help(&ged_view_axes_tree,
	"view obj <object> axes");
