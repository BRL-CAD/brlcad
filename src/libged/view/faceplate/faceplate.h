...
extern int _fp_cmd_schema_msgs(struct ged *gedp, int argc,
	const char **argv, const char *branch);
extern void _fp_cmd_schema_help(struct ged *gedp, const char *branch,
	const char *leaf);
