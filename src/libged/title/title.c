...
GED_DEFINE_TYPED_OPERAND_SCHEMA_POLICY_PROVIDER(title, "title",
    "Get or set the database title", "title", BU_CMD_VALUE_RAW, 0,
    BU_CMD_COUNT_UNLIMITED, "Database title words", BU_CMD_PARSE_OPTIONS_FIRST,
    NULL);
