...
GED_DEFINE_NO_ARG_SCHEMA_POLICY(dbip, "dbip",
    "Report the current database instance pointer", BU_CMD_PARSE_INTERSPERSED);
GED_DEFINE_NO_ARG_SCHEMA_POLICY(get_dbip, "get_dbip",
    "Report the current database instance pointer", BU_CMD_PARSE_INTERSPERSED);
