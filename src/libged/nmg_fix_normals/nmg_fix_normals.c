...
struct ged_cmd_impl nmg_fix_normals_cmd_impl = {
    "nmg_fix_normals",
    ged_nmg_fix_normals,
    GED_CMD_DEFAULT
};
...
const struct ged_cmd *nmg_fix_normals_cmds[] = { &nmg_fix_normals_cmd, NULL };

static const struct ged_plugin pinfo = { nmg_fix_normals_cmds, 1 };
