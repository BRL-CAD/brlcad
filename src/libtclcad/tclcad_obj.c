...
static struct to_cmdtab to_cmds[] = {
    ...
    {"graph_objects_positions",	(char *)0, TO_UNLIMITED, to_pass_through_func, ged_graph_objects_positions},
    {"graph_structure",	(char *)0, TO_UNLIMITED, to_pass_through_func, ged_graph_structure},
