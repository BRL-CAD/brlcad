...
#ifndef GCV_IGES_BREP_IMPORT_H
#define GCV_IGES_BREP_IMPORT_H
...
struct BrepImportStatistics {
    ...
    size_t omitted = 0;
    size_t repairs = 0;
    size_t orientation_faces_reversed = 0;
};
