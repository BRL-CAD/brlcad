...
bview_hash(struct bview *v)
{
   ...
   _bview_settings_hash(state, &v->gvs);
    ...
    _bview_data_arrow_state_hash(state, &v->gv_tcl.gv_data_arrows);
    _bview_data_axes_state_hash(state, &v->gv_tcl.gv_data_axes);
    _bview_data_label_state_hash(state, &v->gv_tcl.gv_data_labels);
    _bview_data_line_state_hash(state, &v->gv_tcl.gv_data_lines);
    _bview_data_polygon_state_hash(state, &v->gv_tcl.gv_data_polygons);
    _bview_data_arrow_state_hash(state, &v->gv_tcl.gv_sdata_arrows);
    _bview_data_axes_state_hash(state, &v->gv_tcl.gv_sdata_axes);
    _bview_data_label_state_hash(state, &v->gv_tcl.gv_sdata_labels);
    _bview_data_line_state_hash(state, &v->gv_tcl.gv_sdata_lines);
    XXH64_update(state, &v->gv_snap_lines, sizeof(int));
    XXH64_update(state, &v->gv_snap_tol_factor, sizeof(double));
    _bview_data_polygon_state_hash(state, &v->gv_tcl.gv_sdata_polygons);
    _bview_grid_state_hash(state, &v->gv_grid);
    _bview_other_state_hash(state, &v->gv_center_dot);
    _bview_other_state_hash(state, &v->gv_tcl.gv_prim_labels);
