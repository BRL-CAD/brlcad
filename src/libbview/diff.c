...
bview_differ(struct bview *v1, struct bview *v2)
{
    ...
    BVIEW_CDIFF(1, _bview_data_arrow_state_differ, gv_tcl.gv_data_arrows);
    BVIEW_CDIFF(1, _bview_data_axes_state_differ, gv_tcl.gv_data_axes);
    BVIEW_CDIFF(1, _bview_data_label_state_differ, gv_tcl.gv_data_labels);
    BVIEW_CDIFF(1, _bview_data_line_state_differ, gv_tcl.gv_data_lines);
    BVIEW_CDIFF(1, _bview_data_polygon_state_differ, gv_tcl.gv_data_polygons);
    BVIEW_CDIFF(1, _bview_data_arrow_state_differ, gv_tcl.gv_sdata_arrows);
    BVIEW_CDIFF(1, _bview_data_axes_state_differ, gv_tcl.gv_sdata_axes);
    BVIEW_CDIFF(1, _bview_data_label_state_differ, gv_tcl.gv_sdata_labels);
    BVIEW_CDIFF(1, _bview_data_line_state_differ, gv_tcl.gv_sdata_lines);
    BVIEW_CDIFF(1, _bview_data_polygon_state_differ, gv_tcl.gv_sdata_polygons);
    BVIEW_CDIFF(1, _bview_grid_state_differ, gv_grid);
    BVIEW_CDIFF(1, _bview_other_state_differ, gv_center_dot);
    BVIEW_CDIFF(1, _bview_other_state_differ, gv_tcl.gv_prim_labels);
