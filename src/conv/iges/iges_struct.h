...
extern struct shell *Add_inner_shell(struct shell *s, int entityno);
extern struct shell *Get_outer_shell(struct shell *s, int entityno);
extern struct face_g_snurb *Get_nurb_surf(int entity_no, struct shell *s);
...
extern void Orient_loops(struct shell *s);
