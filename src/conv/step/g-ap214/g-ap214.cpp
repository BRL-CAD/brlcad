 ...
 * information.
 */
/** @file step/g-ap214.cpp
 *
 * C++ main() for g-ap214 converter.
 *
 */
...
usage()
{
    std::cerr << "Usage: g-ap214 -o outfile.stp infile.g \n" << std::endl;
}
...
main(int argc, char *argv[])
{
    ...
    fn->preprocessor_version_("'BRL-CAD g-ap214 exporter'");
    ...
    schema_tmp->AddNode(new StringNode("'AUTOMOTIVE_DESIGN {1 2 10303 214 0 1 1 1}'"));
