 ...
 * information.
 */
/** @file step/g-ap203e2.cpp
 *
 * C++ main() for g-ap203e2 converter.
 *
 */
...
usage()
{
    std::cerr << "Usage: g-ap203e2 -o outfile.stp infile.g \n" << std::endl;
}
...
main(int argc, char *argv[])
{
    ...
    fn->preprocessor_version_("'BRL-CAD g-ap203e2 exporter'");
    ...
    schema_tmp->AddNode(new StringNode("'AP203_CONFIGURATION_CONTROLLED_3D_DESIGN_OF_MECHANICAL_PARTS_AND_ASSEMBLIES_MIM_LF'"));
