...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}" brep Measured_Periodic_Closure_Band_item.s info
...
if(NOT brep_text MATCHES "Valid: YES, Solid: NO" OR
  ...
  message(FATAL_ERROR "measured periodic closure band BREP validation failed\n${brep_text}")
endif()
...
if(exact_result EQUAL 0)
  message(FATAL_ERROR "--exact unexpectedly accepted the out-of-tolerance closed boundary\n${exact_output}\n${exact_error}")
endif()
