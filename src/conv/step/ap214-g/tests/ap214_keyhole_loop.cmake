...
if(NOT none_result EQUAL 3)
  message(FATAL_ERROR "unrepaired keyhole returned ${none_result}, expected 3\n${none_output}\n${none_error}")
endif()
file(READ "${none_report}" none_text)
if(NOT none_text MATCHES "\"geometry_skipped\":1" OR
   NOT none_text MATCHES "\"invalid_breps\":1" OR
   NOT none_text MATCHES "\"repairs\":0")
  message(FATAL_ERROR "--repair none did not retain the invalid keyhole outcome:\n${none_text}")
endif()
