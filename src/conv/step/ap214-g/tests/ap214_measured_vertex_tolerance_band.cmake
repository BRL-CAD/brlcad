...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}" brep Measured_Vertex_Tolerance_Band_item.s info
...
if(NOT brep_text MATCHES "Valid: YES, Solid: NO" OR
  ...
  message(FATAL_ERROR "measured vertex tolerance band BREP validation failed\n${brep_text}")
endif()
...
if(exact_result EQUAL 0)
  message(FATAL_ERROR "--exact unexpectedly accepted the out-of-tolerance STEP vertices\n${exact_output}\n${exact_error}")
endif()
file(READ "${EXACT_REPORT}" exact_report_text)
string(FIND "${exact_report_text}" "closed STEP edge vertex misses the source curve" found)
if(found EQUAL -1)
