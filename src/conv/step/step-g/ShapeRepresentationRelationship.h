...
#ifndef CONV_STEP_STEP_G_SHAPEREPRESENTATIONRELATIONSHIP_H
#define CONV_STEP_STEP_G_SHAPEREPRESENTATIONRELATIONSHIP_H
...
#endif /* CONV_STEP_STEP_G_SHAPEREPRESENTATIONRELATIONSHIP_H */
