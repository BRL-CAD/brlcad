...
if(NOT import_result EQUAL 0)
  message(FATAL_ERROR
    "single-singular periodic branch fixture failed (${import_result})\n"
    "${import_output}\n${import_error}")
endif()
...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}"
    brep Single_Singular_Periodic_Branch_item.s info
...
if(NOT brep_result EQUAL 0 OR
    ...
    NOT brep_text MATCHES "trims:[ ]+8")
  message(FATAL_ERROR
    "single-singular periodic branch BREP validation failed\n${brep_text}")
endif()
