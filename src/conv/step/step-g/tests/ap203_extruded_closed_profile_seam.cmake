...
if(NOT result EQUAL 0)
  message(FATAL_ERROR
    "closed-profile extrusion seam import failed (${result})\n${stdout}\n${stderr}")
endif()
...
foreach(expected
    ...
    "\"geometry_skipped\":0"
    "\"invalid_breps\":0"
    "\"message\":\"relocated a closed surface seam outside an exact face boundary\"")
...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}"
    brep AP203_Extruded_Closed_Profile_Seam_item.s info
...
if(NOT brep_result EQUAL 0 OR
  ...
  message(FATAL_ERROR
    "closed-profile extrusion BREP validation failed\n${brep_text}")
endif()
