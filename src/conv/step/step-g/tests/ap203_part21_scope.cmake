...
foreach(expected
  ...
  if(found EQUAL -1)
    message(FATAL_ERROR "scope report does not contain ${expected}:\n${report_text}")
  endif()
endforeach()

execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}" brep Scoped_Wireframe_Product_item.s info
...
if(NOT brep_text MATCHES "Valid: YES, Solid: NO" OR
   ...
   NOT brep_text MATCHES "3d curve:[ ]+1")
  message(FATAL_ERROR "scoped wireframe validation failed\n${brep_text}")
endif()
