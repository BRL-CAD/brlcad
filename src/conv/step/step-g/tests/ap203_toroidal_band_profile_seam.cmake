...
if(NOT result EQUAL 0)
  message(FATAL_ERROR
    "toroidal band/profile-seam import failed (${result})\n${stdout}\n${stderr}")
endif()
...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}"
    brep AP203_Toroidal_Band_Profile_Seam_item.s info
...
if(NOT brep_result EQUAL 0 OR
  ...
  message(FATAL_ERROR "toroidal band/profile-seam BREP validation failed\n${brep_text}")
endif()
