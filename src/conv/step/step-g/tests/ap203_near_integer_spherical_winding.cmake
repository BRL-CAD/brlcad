...
if(NOT import_result EQUAL 0)
  message(FATAL_ERROR
    "near-integer spherical winding failed (${import_result})\n"
    "${import_output}\n${import_error}")
endif()
...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}"
    brep AP203_Near_Integer_Spherical_Winding_item.s info
...
if(NOT brep_result EQUAL 0 OR
    ...
    NOT brep_text MATCHES "faces:[ ]+2")
  message(FATAL_ERROR
    "near-integer spherical winding BREP validation failed\n${brep_text}")
endif()
