...
if(NOT result EQUAL 0)
  message(FATAL_ERROR
    "doubly periodic segmented band import failed (${result})\n${stdout}\n${stderr}")
endif()
...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}"
    brep AP203_Doubly_Periodic_Segmented_Band_item.s info
...
if(NOT brep_result EQUAL 0 OR
  ...
  message(FATAL_ERROR
    "doubly periodic segmented band BREP validation failed\n${brep_text}")
endif()
