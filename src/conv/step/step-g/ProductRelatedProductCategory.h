...
#ifndef CONV_STEP_STEP_G_PRODUCTRELATEDPRODUCTCATEGORY_H
#define CONV_STEP_STEP_G_PRODUCTRELATEDPRODUCTCATEGORY_H
...
#endif /* CONV_STEP_STEP_G_PRODUCTRELATEDPRODUCTCATEGORY_H */
