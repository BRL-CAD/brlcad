...
#ifndef CONV_STEP_STEP_G_PARAMETRICREPRESENTATIONCONTEXT_H
#define CONV_STEP_STEP_G_PARAMETRICREPRESENTATIONCONTEXT_H
...
#endif /* CONV_STEP_STEP_G_PARAMETRICREPRESENTATIONCONTEXT_H */
