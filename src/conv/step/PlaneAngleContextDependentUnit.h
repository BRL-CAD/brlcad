 ...
 * information.
 */
/** @file PlaneAngleContextDependentUnit.h
 *
...
#ifndef PLANEANGLECONTEXTDEPENDENTUNIT_H_
#define PLANEANGLECONTEXTDEPENDENTUNIT_H_
...
public:
	...
	PlaneAngleContextDependentUnit(STEPWrapper *sw,int STEPid);
