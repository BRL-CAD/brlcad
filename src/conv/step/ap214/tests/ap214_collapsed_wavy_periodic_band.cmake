...
# the native-seam candidate shift become a tolerance bypass.  Permissive
# exact mode preserves and tags the unresolved geometry instead of omitting it.
...
if(NOT exact_result EQUAL 1)
  message(FATAL_ERROR "step-g --exact returned ${exact_result}, expected 1\n${exact_output}\n${exact_error}")
endif()
