...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}" brep Periodic_Edge_Propagation_item.s info
  OUTPUT_VARIABLE brep_output
  ERROR_VARIABLE brep_error
)
set(brep_text "${brep_output}\n${brep_error}")
if(NOT brep_text MATCHES "Valid: YES, Solid: YES" OR
   NOT brep_text MATCHES "faces:[ ]+3")
  message(FATAL_ERROR "periodic edge propagation BREP validation failed\n${brep_text}")
endif()
