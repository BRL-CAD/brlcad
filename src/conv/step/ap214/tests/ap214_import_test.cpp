...
main(int, char **argv)
{
    ...
    AP214SchemaInfo qualified_legacy = AP214Adapter::inspect_header(part21_header(
	"'AUTOMOTIVE_DESIGN_CC2 { 1 2 10303 214 -1 1 5 1 }'"));
    expect(qualified_legacy.accepted,
	"edition-qualified AUTOMOTIVE_DESIGN_CC2 is accepted");
    expect(qualified_legacy.legacy_cc2,
	"edition-qualified AUTOMOTIVE_DESIGN_CC2 is reported as legacy");
