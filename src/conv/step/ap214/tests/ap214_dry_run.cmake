...
execute_process(
  COMMAND "${STEP_G}" -D -S "${SUMMARY}" --report "${REPORT}" "${INPUT}"
...
if(NOT result EQUAL 0)
  message(FATAL_ERROR "step-g dry run failed (${result}):\n${output}\n${error}")
endif()

if(NOT EXISTS "${SUMMARY}")
  message(FATAL_ERROR "step-g dry run did not write its legacy summary")
endif()
...
if(NOT EXISTS "${REPORT}")
  message(FATAL_ERROR "step-g dry run did not write its report")
endif()
