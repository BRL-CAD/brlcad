...
execute_process(
  COMMAND "${STEP_G}" -j 4 --reject-invalid-objs -O "${OUTPUT}"
    --report "${REPORT}" "${INPUT}"
...
# Both detached roots receive an isolated raw validation candidate.  The valid
# root bypasses safe reconstruction; only the intentionally non-solid root
# proceeds through the repair construction path.
foreach(expected
    ...
    "\"stages\":{"
    "\"brep_construction_pullback\":{\"calls\":1"
    "\"brep_unrepaired_preflight\":{\"calls\":2"
    "\"face_construction_pullback\":{\"calls\":10"
