...
if(NOT import_result EQUAL 0)
  message(FATAL_ERROR
    "vertex-loop torus import returned ${import_result}\n${import_output}\n${import_error}")
endif()
...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}" brep Vertex_Loop_Torus_item.s info
...
if(NOT brep_text MATCHES "Valid: YES, Solid: YES" OR
  ...
  message(FATAL_ERROR "vertex-loop torus BREP validation failed\n${brep_text}")
endif()
