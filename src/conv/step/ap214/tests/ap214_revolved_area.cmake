...
if(NOT ray_result EQUAL 0 OR
   NOT ray_text MATCHES ",-7\\.000000,0\\.000000,0\\.000000,7\\.000000,-6\\.500000" OR
   NOT ray_text MATCHES ",-5\\.500000,0\\.000000,0\\.000000,5\\.500000,-5\\.000000" OR
   NOT ray_text MATCHES ",5\\.000000,0\\.000000,0\\.000000,-5\\.000000,5\\.500000" OR
   NOT ray_text MATCHES ",6\\.500000,0\\.000000,0\\.000000,-6\\.500000,7\\.000000")
...
execute_process(
  COMMAND "${STEP_G}" -O "${partial_output}" --report "${partial_report}" "${partial_input}"
...
if(NOT partial_result EQUAL 0)
  message(FATAL_ERROR "partial step-g returned ${partial_result}\n${partial_import_output}\n${partial_import_error}")
endif()
...
if(NOT partial_brep_text MATCHES "Valid: YES, Solid: YES" OR
   NOT partial_brep_text MATCHES "faces:[ ]+4" OR
   NOT partial_brep_text MATCHES "edges:[ ]+6")
...
# Enter through the angular end plane at a radius inside the profile void.  A
# cap that lost its inner loop would report an entry at x=0 instead of the
# inner revolution wall at x=2.5.
execute_process(
  COMMAND "${NIRT}" -H 0 -b -f csv
    -e "xyz -1 0 -6; dir 1 0 0; s; q"
    "${partial_output}" Revolved_Ring_swept_item
  RESULT_VARIABLE partial_ray_result
  OUTPUT_VARIABLE partial_ray_output
  ERROR_VARIABLE partial_ray_error
)
set(partial_ray_text "${partial_ray_output}\n${partial_ray_error}")
if(NOT partial_ray_result EQUAL 0 OR
   NOT partial_ray_text MATCHES ",2\\.500000,0\\.000000,-6\\.000000,-2\\.500000,3\\.605551")
  message(FATAL_ERROR
    "partial revolved-area void ray failed\n${partial_ray_output}\n${partial_ray_error}")
endif()
