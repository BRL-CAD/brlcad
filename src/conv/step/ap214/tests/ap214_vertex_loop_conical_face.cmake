...
if(NOT import_result EQUAL 0)
  message(FATAL_ERROR
    "vertex-loop conical face import returned ${import_result}\n${import_output}\n${import_error}")
endif()
...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}" brep Vertex_Loop_Conical_Face_item.s info
...
if(NOT brep_text MATCHES "Valid: YES, Solid: NO" OR
  ...
  message(FATAL_ERROR "vertex-loop conical face BREP validation failed\n${brep_text}")
endif()
