if(NOT DEFINED STEP_G OR NOT DEFINED MGED OR NOT DEFINED INPUT OR NOT DEFINED REPORT OR
   NOT DEFINED OUTPUT OR NOT DEFINED STRICT_REPORT OR NOT DEFINED STRICT_OUTPUT)
  message(FATAL_ERROR "STEP_G, MGED, INPUT, REPORT, OUTPUT, STRICT_REPORT, and STRICT_OUTPUT are required")
endif()
...
if(NOT import_result EQUAL 1)
  message(FATAL_ERROR "partial step-g import returned ${import_result}, expected 1\n${import_output}\n${import_error}")
endif()
...
execute_process(
  COMMAND "${STEP_G}" -O "${STRICT_OUTPUT}" --strict --report "${STRICT_REPORT}" "${INPUT}"
  RESULT_VARIABLE strict_result
  OUTPUT_VARIABLE strict_output
  ERROR_VARIABLE strict_error
)
if(NOT strict_result EQUAL 3)
  message(FATAL_ERROR "strict step-g import returned ${strict_result}, expected 3\n${strict_output}\n${strict_error}")
endif()
