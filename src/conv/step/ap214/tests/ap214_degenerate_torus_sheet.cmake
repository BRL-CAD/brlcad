...
execute_process(
  COMMAND "${STEP_G}" -j 1 --budget-scale 1 -O "${OUTPUT}"
    --report "${REPORT}" "${INPUT}"
...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}"
    brep Degenerate_Torus_Sheet_item.s info
...
if(NOT brep_result EQUAL 0 OR
  ...
  message(FATAL_ERROR "selected degenerate torus sheet validation failed\n${brep_text}")
endif()
