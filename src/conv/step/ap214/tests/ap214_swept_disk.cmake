if(NOT DEFINED STEP_G OR NOT DEFINED MGED OR NOT DEFINED NIRT OR NOT DEFINED INPUT OR NOT DEFINED REPORT OR NOT DEFINED OUTPUT)
  message(FATAL_ERROR "STEP_G, MGED, NIRT, INPUT, REPORT, and OUTPUT are required")
endif()
...
execute_process(
  COMMAND "${MGED}" -c "${OUTPUT}"
    brep Hollow_Sweep_swept_item_step44.s info
...
if(NOT circular_result EQUAL 0 OR
  ...
  message(FATAL_ERROR
    "circular swept-disk BREP validation failed\n${circular_text}")
endif()
