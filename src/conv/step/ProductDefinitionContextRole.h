 ...
 * information.
 */
/** @file step/ProductDefinitionContextRole.h
 *
 * Class definition used to convert STEP "ProductDefinitionContextRole" to BRL-CAD BREP
 * structures.
 *
 */

#ifndef PRODUCT_DEFINITION_CONTEXT_ROLE_H_
#define PRODUCT_DEFINITION_CONTEXT_ROLE_H_
