...
/** Encode UTF-8 text as a quoted ISO 10303-21 string token.
 *
 * Printable ASCII is retained, apostrophes are doubled, and characters that
 * would otherwise be ambiguous in Part 21 (including backslashes and
 * non-ASCII text) use the portable \X2\ Unicode form.
 */
