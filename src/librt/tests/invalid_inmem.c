 ...
 * information.
 */
/** @file invalid_inmem.c
 *
 * Test routines for repairing in-memory representations of invalid
 * primitives.
 *
 * We do this inmem because some of the primitive I/O routines will
 * refuse to write invalid inputs to disk, so we can't store them
 * for reuse that way.
 */
