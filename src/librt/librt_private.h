...
struct rt_brep_trace_edge {
    ...
    fastf_t discrepancy_lower_bound;
    fastf_t discrepancy_upper_bound;
    fastf_t discrepancy_bound_tolerance;
    ...
    size_t correspondence_cells;
    size_t correspondence_depth;
