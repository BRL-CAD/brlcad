...
const struct bu_structparse rt_revolve_parse[] = {
    { "%f", 3, "V",   bu_offsetofarray(struct rt_revolve_internal, v3d, point_t, X),  BU_STRUCTPARSE_FUNC_NULL, NULL, NULL },
    { "%f", 3, "axis", bu_offsetofarray(struct rt_revolve_internal, axis3d, vect_t, X),  BU_STRUCTPARSE_FUNC_NULL, NULL, NULL },
    { "%f", 3, "R",   bu_offsetofarray(struct rt_revolve_internal, r, vect_t, X), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL },
