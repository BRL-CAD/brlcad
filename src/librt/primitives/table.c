...
const struct rt_functab rt_functab[] = {
    ...
    {RT_FUNCTAB_MAGIC, "ID_CLINE", "cline",
     ...
     rt_cline_plot,	rt_cline_vshot,	rt_cline_tess,	rt_nul_tnurb,
    ...
    {RT_FUNCTAB_MAGIC, "ID_BOT", "bot",
     ...
     rt_bot_plot,	rt_bot_vshot,	rt_bot_tess,	rt_nul_tnurb,
    ...
    {RT_FUNCTAB_MAGIC, "ID_SUPERELL", "superell",
     ...
     rt_superell_plot,	rt_superell_vshot,	rt_superell_tess,	rt_nul_tnurb,
