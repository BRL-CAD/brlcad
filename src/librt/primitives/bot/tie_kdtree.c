...
static void
find_split_fast(tie_kdtree_t *node, TIE_3 *cmin, TIE_3 *cmax, unsigned int *split)
{
    /**********************
     * MID-SPLIT ALGORITHM *
     ***********************/
...
#if 1
static void
find_split_optimal(tie_t *tie, tie_kdtree_t *node, TIE_3 *cmin, TIE_3 *cmax, unsigned int *split)
{
    /****************************************
...
static void
tie_kdtree_build(tie_t *tie, tie_kdtree_t *node, unsigned int depth, TIE_3 min, TIE_3 max)
{
    tie_geom_t *child[2], *node_gd = (tie_geom_t *)(node->data);
