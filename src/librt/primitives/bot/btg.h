...
void bottie_push_double(void *vtie, double *tri, unsigned int ntri, void *plist, unsigned int pstride);
void bottie_prep_double(void *vtie);
...
void bottie_push_float(void *vtie, float *tri, unsigned int ntri, void *plist, unsigned int pstride);
void bottie_prep_float(void *vtie);
