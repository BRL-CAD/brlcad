...
ecmd_bot_mode(struct rt_solid_edit *s)
{
    ...
    bu_clbk_t f = NULL;
    void *d = NULL;
    rt_solid_edit_map_clbk_get(&f, &d, s->m, ECMD_BOT_MODE, 0, BU_CLBK_DURING);
    if (f)
	(*f)(0, NULL, d, s);
...
ecmd_bot_orient(struct rt_solid_edit *s)
{
    ...
    bu_clbk_t f = NULL;
    void *d = NULL;
    rt_solid_edit_map_clbk_get(&f, &d, s->m, ECMD_BOT_ORIENT, 0, BU_CLBK_DURING);
    if (f)
	(*f)(0, NULL, d, s);
}
...
ecmd_bot_thick(struct rt_solid_edit *s)
{
    ...
    bu_clbk_t f = NULL;
    void *d = NULL;
    rt_solid_edit_map_clbk_get(&f, &d, s->m, ECMD_BOT_THICK, 0, BU_CLBK_DURING);
    if (f)
	(*f)(0, NULL, d, s);
...
ecmd_bot_flags(struct rt_solid_edit *s)
{
    ...
    bu_clbk_t f = NULL;
    void *d = NULL;
    rt_solid_edit_map_clbk_get(&f, &d, s->m, ECMD_BOT_FLAGS, 0, BU_CLBK_DURING);
    if (f)
	(*f)(0, NULL, d, s);
}
...
ecmd_bot_fmode(struct rt_solid_edit *s)
{
    ...
    bu_clbk_t f = NULL;
    void *d = NULL;
    rt_solid_edit_map_clbk_get(&f, &d, s->m, ECMD_BOT_FMODE, 0, BU_CLBK_DURING);
    if (f)
	(*f)(0, NULL, d, s);
}
...
ecmd_bot_pickt(struct rt_solid_edit *s, const vect_t mousevec)
{
	...
	bu_clbk_t f = NULL;
	void *d = NULL;
	rt_solid_edit_map_clbk_get(&f, &d, s->m, ECMD_BOT_PICKT, 0, BU_CLBK_DURING);
	if (f)
	    (*f)(0, NULL, d, s);
