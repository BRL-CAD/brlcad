...
const struct bu_structparse rt_rhc_parse[] = {
    { "%f", 3, "V", (long)bu_offsetof(struct rt_rhc_internal, rhc_V[X]), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL },
    { "%f", 3, "H", (long)bu_offsetof(struct rt_rhc_internal, rhc_H[X]), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL },
    { "%f", 3, "B", (long)bu_offsetof(struct rt_rhc_internal, rhc_B[X]), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL },
