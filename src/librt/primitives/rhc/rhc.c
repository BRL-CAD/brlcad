...
rt_rhc_tess(struct nmgregion **r, struct model *m, struct rt_db_internal *ip, const struct bg_tess_tol *ttol, const struct bn_tol *tol)
{
    ...
    *r = nmg_mrsv(m);	/* Make region, empty shell, vertex */
    ...
    (void)nmg_mark_edges_real(&outfaceuses[1]->l.magic, &rtg_vlfree);
    ...
    (void)nmg_mark_edges_real(&outfaceuses[n + 1]->l.magic,&rtg_vlfree);
    ...
    nmg_gluefaces(outfaceuses, n + 2, &rtg_vlfree, tol);
