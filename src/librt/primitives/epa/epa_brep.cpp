...
rt_epa_brep(ON_Brep **b, const struct rt_db_internal *ip, const struct bn_tol *tol)
{
    ...
    *b = new ON_Brep();
    ...
    epacurvedsurf->SetKnot(1, 2, 10.4);
    epacurvedsurf->SetKnot(1, 3, 10.4);

    ON_4dPoint pt01 = ON_4dPoint(0,0,0,1);
    epacurvedsurf->SetCV(0,0,pt01);
    ON_4dPoint pt02 = ON_4dPoint(0,5,0,1);
    epacurvedsurf->SetCV(0,1,pt02);
    ON_4dPoint pt03 = ON_4dPoint(0,10,2.5,1);
    epacurvedsurf->SetCV(0,2,pt03);
    
    ON_4dPoint pt04 = ON_4dPoint(0,0,0,1/sqrt(2));
    epacurvedsurf->SetCV(1,0,pt04);      
    ON_4dPoint pt05 = ON_4dPoint(-10/sqrt(2),5/sqrt(2),0,1/sqrt(2));
    epacurvedsurf->SetCV(1,1,pt05);      
    ON_4dPoint pt06 = ON_4dPoint(-20/sqrt(2),10/sqrt(2),2.5/sqrt(2),1/sqrt(2));
    epacurvedsurf->SetCV(1,2,pt06);
    
    ON_4dPoint pt07 = ON_4dPoint(0,0,0,1);
    epacurvedsurf->SetCV(2,0,pt07);      
    ON_4dPoint pt08 = ON_4dPoint(-10,0,0,1);
    epacurvedsurf->SetCV(2,1,pt08);      
    ON_4dPoint pt09 = ON_4dPoint(-20,0,2.5,1);
    epacurvedsurf->SetCV(2,2,pt09);
    
    ON_4dPoint pt10 = ON_4dPoint(0,0,0,1/sqrt(2));
    epacurvedsurf->SetCV(3,0,pt10);      
    ON_4dPoint pt11 = ON_4dPoint(-10/sqrt(2),-5/sqrt(2),0,1/sqrt(2));
    epacurvedsurf->SetCV(3,1,pt11);      
    ON_4dPoint pt12 = ON_4dPoint(-20/sqrt(2),-10/sqrt(2),2.5/sqrt(2),1/sqrt(2));
    epacurvedsurf->SetCV(3,2,pt12);
    
    ON_4dPoint pt13 = ON_4dPoint(0,0,0,1);
    epacurvedsurf->SetCV(4,0,pt13);      
    ON_4dPoint pt14 = ON_4dPoint(0,-5,0,1);
    epacurvedsurf->SetCV(4,1,pt14);      
    ON_4dPoint pt15 = ON_4dPoint(0,-10,2.5,1);
    epacurvedsurf->SetCV(4,2,pt15);
   
    ON_4dPoint pt16 = ON_4dPoint(0,0,0,1/sqrt(2));
    epacurvedsurf->SetCV(5,0,pt16);      
    ON_4dPoint pt17 = ON_4dPoint(10/sqrt(2),-5/sqrt(2),0,1/sqrt(2));
    epacurvedsurf->SetCV(5,1,pt17);      
    ON_4dPoint pt18 = ON_4dPoint(20/sqrt(2),-10/sqrt(2),2.5/sqrt(2),1/sqrt(2));
    epacurvedsurf->SetCV(5,2,pt18);
    
    ON_4dPoint pt19 = ON_4dPoint(0,0,0,1);
    epacurvedsurf->SetCV(6,0,pt19);      
    ON_4dPoint pt20 = ON_4dPoint(10,0,0,1);
    epacurvedsurf->SetCV(6,1,pt20);      
    ON_4dPoint pt21 = ON_4dPoint(20,0,2.5,1);
    epacurvedsurf->SetCV(6,2,pt21);
    
    ON_4dPoint pt22 = ON_4dPoint(0,0,0,1/sqrt(2));
    epacurvedsurf->SetCV(7,0,pt22);      
    ON_4dPoint pt23 = ON_4dPoint(10/sqrt(2),5/sqrt(2),0,1/sqrt(2));
    epacurvedsurf->SetCV(7,1,pt23);      
    ON_4dPoint pt24 = ON_4dPoint(20/sqrt(2),10/sqrt(2),2.5/sqrt(2),1/sqrt(2));
    epacurvedsurf->SetCV(7,2,pt24);
   
    ON_4dPoint pt25 = ON_4dPoint(0,0,0,1);
    epacurvedsurf->SetCV(8,0,pt25);      
    ON_4dPoint pt26 = ON_4dPoint(0,5,0,1);
    epacurvedsurf->SetCV(8,1,pt26);      
    ON_4dPoint pt27 = ON_4dPoint(0,10,2.5,1);
