...
const struct bu_structparse rt_vol_parse[] = {
    {"%s", RT_VOL_NAME_LEN, "file", (long)bu_offsetofarray(struct rt_vol_internal, file), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL },
    ...
    {"%f", ELEMENTS_PER_VECT, "size", (long)bu_offsetofarray(struct rt_vol_internal, cellsize), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL },
    {"%f", 16, "mat", (long)bu_offsetofarray(struct rt_vol_internal, mat), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL },
