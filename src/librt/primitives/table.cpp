...
#define RT_DECLARE_INTERFACE(name) \
    ...
    extern int rt_##name##_scene_obj(struct bv_scene_obj *vhead, struct rt_db_internal *ip, const struct bg_tess_tol *ttol, const struct bn_tol *tol, const struct bview *info) \
...
extern int rt_generic_scene_obj(struct bv_scene_obj *s, struct rt_db_internal *ip, const struct bg_tess_tol *ttol, const struct bn_tol *tol, const struct bview *v);
