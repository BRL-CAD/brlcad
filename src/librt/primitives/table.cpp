...
#define RT_DECLARE_INTERFACE(name) \
    ...
    extern int rt_##name##_plot(struct bu_list *vhead, struct rt_db_internal *ip, const struct bg_tess_tol *ttol, const struct bn_tol *tol, const struct bv *info); \
    extern int rt_##name##_adaptive_plot(struct bu_list *vhead, struct rt_db_internal *ip, const struct bn_tol *tol, const struct bv *v, fastf_t s_size); \
    ...
    extern void rt_##name##_labels(struct bu_ptbl *labels, const struct rt_db_internal *ip, struct bv *v)
