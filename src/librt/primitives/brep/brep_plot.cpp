...
void
plotleaf3d(BBNode* bb,double within_distance_tol)
{
    vect_t min;
    vect_t max;
    fastf_t u, v;
...
void
plotsurface(ON_Surface &surf, struct bn_vlblock *vbp, int isocurveres, int gridres, const int red, const int green, const int blue)
{
    register struct bu_list *vhead;
    fastf_t pt1[3], pt2[3];
    ON_2dPoint from, to;
...
void
plotcurve(ON_Curve &curve, struct bn_vlblock *vbp, int plotres, const int red, const int green, const int blue)
{
    register struct bu_list *vhead;
    fastf_t pt1[3], pt2[3];
    ON_2dPoint from, to;
...
int
brep_surface_uv_plot_interval(struct bu_vls *vls, struct brep_specific* bs, struct rt_brep_internal*, struct bn_vlblock *vbp, int index, ON_Interval &U, ON_Interval &V)
{
    ON_wString wstr;
    ON_TextLog tl(wstr);
...
int
brep_loop_plot(struct bu_vls *vls, struct brep_specific* bs, struct rt_brep_internal*, struct bn_vlblock *vbp, int index, int plotres, bool dim3d)
{
    ON_wString wstr;
    ON_TextLog ll(wstr);
