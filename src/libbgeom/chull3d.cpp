 ...
 * chull3d_intermediate_set and bgeom_3d_chull.  In the
...
int
bgeom_3d_chull(int **faces, int *num_faces, point_t **vertices, int *num_vertices,
	const point_t *input_points_3d, int num_input_pnts)
{
	...
	case 2:
	    ...
	    bgeom_3d_coplanar_chull(&hull_2d, (const point_t *)cdata->vert_array, (*cdata->vert_cnt));
	    (*vertices) = hull_2d;
