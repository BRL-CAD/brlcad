...
MACRO(ADD_TK_CFLAG TK_CFLAG)
	SET(TK_CFLAGS "${TK_CFLAGS} -D${TK_CFLAG}=1" CACHE STRING "TCL CFLAGS" FORCE)
...
MACRO(SC_TCL_CFG_ENCODING)
	...
	SET(TK_CFLAGS "${TK_CFLAGS} -DTCL_CFGVAL_ENCODING=\\\"${TCL_CFGVAL_ENCODING}\\\"" CACHE STRING "TCL CFLAGS" FORCE)
