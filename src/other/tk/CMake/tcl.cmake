...
MACRO(SC_TCL_LINK_LIBS)
	...
	IF(NOT HAVE_CONNECT)
		...
		IF(NOT HAVE_SETSOCKOPT)
			CHECK_LIBRARY_EXISTS(SOCKET socket connect)
			IF(TCL_LINK_LIBS)
	...
	IF(NOT HAVE_GETHOSTBYNAME)
		CHECK_LIBRARY_EXISTS(NSL nsl gethostbyname)
		IF(NSL_LIBRARY)
			IF(TCL_LINK_LIBS)
