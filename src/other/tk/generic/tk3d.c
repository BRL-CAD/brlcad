				 ...
				 * background. */
{
    ...
    borderPtr->shadow = TkNone;
    borderPtr->bgGC = TkNone;
    borderPtr->darkGC = TkNone;
    borderPtr->lightGC = TkNone;
				 ...
				 * TK_3D_DARK_GC. */
{
    ...
    if ((borderPtr->lightGC == TkNone) && (which != TK_3D_FLAT_GC)) {
