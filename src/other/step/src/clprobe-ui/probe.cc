...
//    const char *EntityNameArray[count + 1];
    ...
    while( count > 0 ) {
        ...
        if( enDesc ) {
            ...
            EntityNameArray[count] = "There is a BUG in this program.";
        }
        -- count;
    }
    count = registry -> GetFullEntCnt();
