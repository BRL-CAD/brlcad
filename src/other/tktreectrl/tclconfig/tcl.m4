...
AC_DEFUN([TEA_LOAD_TCLCONFIG], [
	...
	*)
	...
	CLEANFILES="$CLEANFILES *.lib *.dll *.pdb *.exp *.ilk vc*.pch"
    fi
...
# TEA_ADD_MANIFEST --
#
#	Specify manifest file on Windows. A package can have its own
#	manifest which may be merged with any manifest generated by
