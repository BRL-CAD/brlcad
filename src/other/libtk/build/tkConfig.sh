...
TK_DEFS=' -DHAVE_UNISTD_H=1 -DHAVE_LIMITS_H=1 -DTCL_WIDE_INT_TYPE=long\ long -DSTDC_HEADERS=1 -DHAVE_SYS_TIME_H=1 -DTIME_WITH_SYS_TIME=1 -DHAVE_PW_GECOS=1 '
...
# build directory.
TK_BUILD_LIB_SPEC='-L/Volumes/Oxford/BRL-CAD/brlcad/libtk8.4/build -ltk8.4'
...
# compiled.
TK_SRC_DIR='/Volumes/Oxford/BRL-CAD/brlcad/libtk8.4'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Volumes/Oxford/BRL-CAD/brlcad/libtk8.4/build -ltkstub8.4'
...
TK_BUILD_STUB_LIB_PATH='/Volumes/Oxford/BRL-CAD/brlcad/libtk8.4/build/libtkstub8.4.a'
