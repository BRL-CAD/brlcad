...
/* 77 */
EXTERN void		TclpGetTime (Tcl_Time * localTime);
#endif
#ifndef TclpGetTimeZone_TCL_DECLARED
#define TclpGetTimeZone_TCL_DECLARED
/* 78 */
EXTERN int		TclpGetTimeZone (unsigned long localTime);
#endif
/* Slot 79 is reserved */
/* Slot 80 is reserved */
...
/* 133 */
EXTERN struct tm *	TclpGetDate (CONST time_t * localTime, int useGMT);
#endif
...
EXTERN void		TclHideLiteral (Tcl_Interp * interp, 
				struct CompileEnv * envPtr, int localIndex);
#endif
...
/* 151 */
EXTERN void		TclRegExpRangeUniChar (Tcl_RegExp re, int localIndex, 
...
EXTERN int		TclListObjSetElement (Tcl_Interp * interp, 
				Tcl_Obj * listPtr, int localIndex, 
				Tcl_Obj * valuePtr);
#endif
...
/* 182 */
EXTERN struct tm *	TclpLocaltime (CONST time_t * localClock);
#endif
#ifndef TclpGmtime_TCL_DECLARED
#define TclpGmtime_TCL_DECLARED
/* 183 */
EXTERN struct tm *	TclpGmtime (CONST time_t * localClock);
#endif
...
typedef struct TclIntStubs {
    ...
    void (*tclpGetTime) (Tcl_Time * localTime); /* 77 */
    int (*tclpGetTimeZone) (unsigned long localTime); /* 78 */
    void *reserved79;
    void *reserved80;
    ...
    struct tm * (*tclpGetDate) (CONST time_t * localTime, int useGMT); /* 133 */
    void *reserved134;
    void *reserved135;
    void *reserved136;
    void *reserved137;
    ...
    void (*tclHideLiteral) (Tcl_Interp * interp, struct CompileEnv * envPtr, int localIndex); /* 144 */
    ...
    void (*tclRegExpRangeUniChar) (Tcl_RegExp re, int localIndex, int * startPtr, int * endPtr); /* 151 */
    ...
    int (*tclListObjSetElement) (Tcl_Interp * interp, Tcl_Obj * listPtr, int localIndex, Tcl_Obj * valuePtr); /* 166 */
    ...
    void *reserved180;
    void *reserved181;
    struct tm * (*tclpLocaltime) (CONST time_t * localClock); /* 182 */
    struct tm * (*tclpGmtime) (CONST time_t * localClock); /* 183 */
    void *reserved184;
    void *reserved185;
    void *reserved186;
    void *reserved187;
    ...
    int (*tclPtrMakeUpvar) (Tcl_Interp * interp, Var * otherP1Ptr, CONST char * myName, int myFlags, int localIndex); /* 229 */
