...
#ifndef TINYCTHREAD_EXPORT
#  if defined(TINYCTHREAD_DLL_EXPORTS) && defined(TINYCTHREAD_DLL_IMPORTS)
#    error "Only TINYCTHREAD_DLL_EXPORTS or TINYCTHREAD_DLL_IMPORTS can be defined, not both."
#  elif defined(TINYCTHREAD_DLL_EXPORTS)
#    define TINYCTHREAD_EXPORT __declspec(dllexport)
#  elif defined(TINYCTHREAD_DLL_IMPORTS)
#    define TINYCTHREAD_EXPORT __declspec(dllimport)
#  else
#    define TINYCTHREAD_EXPORT
#  endif
#endif
...
* @param mtx A mutex object.
*/
TINYCTHREAD_EXPORT extern void mtx_destroy(mtx_t *mtx);
...
/** NOT YET IMPLEMENTED.
*/
TINYCTHREAD_EXPORT extern int mtx_timedlock(mtx_t *mtx, const struct timespec *ts);
...
* honored.
*/
TINYCTHREAD_EXPORT extern int mtx_trylock(mtx_t *mtx);
...
* @param cond A condition variable object.
*/
TINYCTHREAD_EXPORT extern void cnd_destroy(cnd_t *cond);
...
*/
TINYCTHREAD_EXPORT extern int cnd_timedwait(cnd_t *cond, mtx_t *mtx, const struct timespec *ts);
...
* thread.
*/
TINYCTHREAD_EXPORT extern int thrd_create(thrd_t *thr, thrd_start_t func, void *arg);

/** Identify the calling thread.
* @return The identifier of the calling thread.
*/
TINYCTHREAD_EXPORT extern thrd_t thrd_current(void);

/** Dispose of any resources allocated to the thread when that thread exits.
 * @return thrd_success, or thrd_error on error
*/
TINYCTHREAD_EXPORT extern int thrd_detach(thrd_t thr);
...
*/
TINYCTHREAD_EXPORT extern int thrd_equal(thrd_t thr0, thrd_t thr1);

/** Terminate execution of the calling thread.
* @param res Result code of the calling thread.
*/
TINYCTHREAD_EXPORT extern void thrd_exit(int res) TTHREAD_NORETURN;
...
*/
TINYCTHREAD_EXPORT extern int thrd_sleep(const struct timespec *duration, struct timespec *remaining);

/** Yield execution to another thread.
* Permit other threads to run, even if the current thread would ordinarily
* continue to run.
*/
TINYCTHREAD_EXPORT extern void thrd_yield(void);
...
*/
TINYCTHREAD_EXPORT extern int tss_create(tss_t *key, tss_dtor_t dtor);
...
*/
TINYCTHREAD_EXPORT extern void tss_delete(tss_t key);
...
* storage.
*/
TINYCTHREAD_EXPORT extern void *tss_get(tss_t key);
