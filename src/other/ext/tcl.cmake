...
if (BRLCAD_TCL_BUILD)
  ...
  if (NOT MSVC)
    ...
    ExternalProject_Add(TCL_BLD
      ...
      CONFIGURE_COMMAND LD_LIBRARY_PATH=-L${CMAKE_BINARY_ROOT}/${LIB_DIR} CPPFLAGS=-I${CMAKE_BINARY_ROOT}/${INCLUDE_DIR} LDFLAGS=-L${CMAKE_BINARY_ROOT}/${LIB_DIR} TCL_SHLIB_LD_EXTRAS=-L${CMAKE_BINARY_ROOT}/${LIB_DIR} ${TCL_SRC_DIR}/unix/configure --prefix=${TCL_INSTDIR}
