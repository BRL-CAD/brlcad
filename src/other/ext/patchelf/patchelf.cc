 ...
 *
 *  Note - this copy from https://github.com/NixOS/patchelf with mods to
...
#define PACKAGE_STRING "BRL-CAD bundled patchelf (sourced from https://github.com/NixOS/patchelf)"
...
template<ElfFileParams>
ElfFile<ElfFileParamNames>::ElfFile(FileContents fC)
    : fileContents(fC)
