...
if (BRLCAD_PROJ_BUILD)
  ...
  if (MSVC)
    ...
    #set(PROJ_SUFFIX ${PROJ_DEBUG_POSTFIX}${CMAKE_SHARED_LIBRARY_SUFFIX})
    set(PROJ_SUFFIX _${PROJ_MAJOR_VERSION}_${PROJ_MINOR_VERSION}${PROJ_DEBUG_POSTFIX}${CMAKE_SHARED_LIBRARY_SUFFIX})
  ...
  ExternalProject_Add(PROJ_BLD
    ...
    -DSQLITE3_INCLUDE_DIR=$<$<BOOL:${SQLITE3_TARGET}>:${CMAKE_BINARY_ROOT}/${INCLUDE_DIR}>
    -DEXE_SQLITE3=$<$<BOOL:${SQLITE3_TARGET}>:${SQLITE3_EXECNAME}>
    -DBUILD_TESTING=OFF
    -DENABLE_TIFF=OFF
    -DENABLE_CURL=OFF
    -DBUILD_PROJSYNC=OFF
  ...
  ExternalProject_Target(SHARED proj PROJ_BLD ${PROJ_INSTDIR}
    ...
    RPATH
    WIN_DIF_LIB_NAME ${PROJ_BASENAME}${PROJ_DEBUG_POSTFIX}${CMAKE_STATIC_LIBRARY_SUFFIX}
    )
