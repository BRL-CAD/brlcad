...
THIRD_PARTY(sqlite3 SQLITE3 sqlite3
  ...
  RESET_VARS EXE_SQLITE3 SQLITE3_LIBRARY SQLITE3_LIBRARIES SQLITE3_INCLUDE_DIR SQLITE3_INCLUDE_DIRS SQLITE3_LIBRARY_DEBUG SQLITE3_LIBRARY_RELEASE
  )
...
if (BRLCAD_SQLITE3_BUILD)
  ...
  set(SQLITE3_LIBRARY_DEBUG sqlite3 CACHE STRING "Building bundled sqlite3" FORCE)
  set(SQLITE3_LIBRARY_RELEASE sqlite3 CACHE STRING "Building bundled sqlite3" FORCE)
  set(SQLITE3_LIBRARIES sqlite3 CACHE STRING "Building bundled sqlite3" FORCE)
  ...
  set(EXE_SQLITE3 sqlite3_exe CACHE STRING "Building bundled sqlite3" FORCE)
  ...
  if (NOT DEFINED SQLITE3_LIBRARIES)
    if (SQLITE3_LIBRARY_RELEASE)
      set(SQLITE3_LIBRARIES ${SQLITE3_LIBRARY_RELEASE} CACHE STRING "SQLITE3_LIBRARIES" FORCE)
    else (SQLITE3_LIBRARY_DEBUG)
      set(SQLITE3_LIBRARIES ${SQLITE3_LIBRARY_DEBUG} CACHE STRING "SQLITE3_LIBRARIES" FORCE)
    endif (SQLITE3_LIBRARY_RELEASE)
  endif (NOT DEFINED SQLITE3_LIBRARIES)
