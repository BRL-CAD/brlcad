...
if (BRLCAD_SQLITE3_BUILD)
  ...
  if (MSVC)
    ...
    set(SQLITE3_STATICNAME libsqlite3)
    set(SQLITE3_SUFFIX ${CMAKE_SHARED_LIBRARY_SUFFIX})
    set(SQLITE3_SYMLINK_1 ${SQLITE3_BASENAME}${CMAKE_SHARED_LIBRARY_SUFFIX})
    set(SQLITE3_SYMLINK_2 ${SQLITE3_BASENAME}${CMAKE_SHARED_LIBRARY_SUFFIX}.${SQLITE3_VMAJ})
  else (MSVC)
