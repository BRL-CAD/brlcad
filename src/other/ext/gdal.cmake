...
if (BRLCAD_GDAL_BUILD)
  ...
  if (MSVC)
    ...
    set(PROJ_LIBRARY ${CMAKE_BINARY_ROOT}/${LIB_DIR}/${PROJ_BASENAME}${PROJ_DEBUG_POSTFIX}.lib)
  elseif (OPENBSD)
  ...
  if (MSVC)
    if ("${CMAKE_BUILD_TYPE}" MATCHES "^([Dd][Ee][Bb][Uu][Gg])$")
      set(GDAL_DEBUG_POSTFIX "d")
    endif("${CMAKE_BUILD_TYPE}" MATCHES "^([Dd][Ee][Bb][Uu][Gg])$")
    set(GDAL_BASENAME gdal${GDAL_DEBUG_POSTFIX})
  ...
  ExternalProject_Add(GDAL_BLD
    ...
    -DGDAL_USE_INTERNAL_LIBS=OFF # GEOTIFF, GIF, JPEG, JSONC, LERC, OPENCAD, PNG, QHULL, TIFF, ZLIB
    ...
    -DGDAL_USE_SQLITE3=$<BOOL:${SQLITE3_TARGET}>
    -DSQLITE3_INCLUDE_DIR=$<$<BOOL:${SQLITE3_TARGET}>:${SQLite3_INCLUDE_DIRS}>
    -DSQLITE3_LIBRARY=$<$<BOOL:${SQLITE3_TARGET}>:${SQLITE3_LIBRARY}>
    ...
    #-DOGR_ENABLE_DRIVER_AVCBIN=ON
    #-DOGR_ENABLE_DRIVER_AVCE00=ON
    ...
    #-DOGR_ENABLE_DRIVER_FILEGDB=ON
    #-DOGR_ENABLE_DRIVER_PDF=ON
