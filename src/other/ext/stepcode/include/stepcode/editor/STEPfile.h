...
class STEPCODE_EDITOR_EXPORT STEPfile {
    protected:
        //data members
...
// obsolete
        ...
        SDAI_Application_instance  *  CreateInstance( istream & in, std::ostream & out );
        ...
        SDAI_Application_instance  * ReadInstance( istream & in, std::ostream & out,
