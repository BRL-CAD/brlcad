...
class STEPCODE_EDITOR_EXPORT ReplicateLinkNode : public SingleLinkNode {
    private:
    protected:
        MgrNode * _repNode;
    public:
...
class STEPCODE_EDITOR_EXPORT ReplicateList : public SingleLinkList {
    private:
    protected:
    public:
        ReplicateList()  { }
...
class STEPCODE_EDITOR_EXPORT CmdMgr {
    protected:
