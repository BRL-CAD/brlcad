...
extern STEPCODE_EDITOR_EXPORT AttrDescriptor * a_0section;
extern STEPCODE_EDITOR_EXPORT AttrDescriptor * a_1default_language;

class STEPCODE_EDITOR_EXPORT SdaiSection_language  :    public SDAI_Application_instance {
    protected:
...
extern STEPCODE_EDITOR_EXPORT AttrDescriptor * a_2governing_schema;
extern STEPCODE_EDITOR_EXPORT AttrDescriptor * a_3determination_method;
extern STEPCODE_EDITOR_EXPORT AttrDescriptor * a_4governed_sections;

class STEPCODE_EDITOR_EXPORT SdaiFile_population  :    public SDAI_Application_instance {
    protected:
...
class STEPCODE_EDITOR_EXPORT SdaiFile_name  :    public SDAI_Application_instance {
    protected:
        SDAI_String _name ;
...
extern STEPCODE_EDITOR_EXPORT AttrDescriptor * a_12section;
extern STEPCODE_EDITOR_EXPORT AttrDescriptor * a_13context_identifiers;

class STEPCODE_EDITOR_EXPORT SdaiSection_context  :    public SDAI_Application_instance {
    protected:
        SDAI_String _section ;    //  OPTIONAL
...
extern STEPCODE_EDITOR_EXPORT AttrDescriptor * a_14description;
extern STEPCODE_EDITOR_EXPORT AttrDescriptor * a_15implementation_level;

class STEPCODE_EDITOR_EXPORT SdaiFile_description  :    public SDAI_Application_instance {
    protected:
...
extern STEPCODE_EDITOR_EXPORT AttrDescriptor * a_16schema_identifiers;

class STEPCODE_EDITOR_EXPORT SdaiFile_schema  :    public SDAI_Application_instance {
    protected:
...
class STEPCODE_EDITOR_EXPORT SdaiModel_contents_header_section_schema : public SDAI_Model_contents {
...
STEPCODE_EDITOR_EXPORT SDAI_Model_contents_ptr create_SdaiModel_contents_header_section_schema();
#endif
