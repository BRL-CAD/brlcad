...
class STEPCODE_DAI_EXPORT SDAI_Model_contents_instances : public SDAI_DAObject {
    public:
...
class STEPCODE_DAI_EXPORT SDAI_Model_contents : public SDAI_Session_instance {
