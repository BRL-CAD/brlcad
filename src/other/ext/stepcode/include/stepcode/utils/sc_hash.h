#ifndef STEPCODE_HASH_H
#define STEPCODE_HASH_H
...
extern "C" {
    ...
    STEPCODE_UTILS_EXPORT struct Hash_Table * STEPCODE_HASHcreate( unsigned );
    STEPCODE_UTILS_EXPORT void               STEPCODE_HASHinitialize( void );
    STEPCODE_UTILS_EXPORT void       *       STEPCODE_HASHfind( struct Hash_Table *,  char * );
    STEPCODE_UTILS_EXPORT void               STEPCODE_HASHinsert( struct Hash_Table *, char *, void * );
    STEPCODE_UTILS_EXPORT void               STEPCODE_HASHdestroy( struct Hash_Table * );
    STEPCODE_UTILS_EXPORT struct Element  *  STEPCODE_HASHsearch( struct Hash_Table *, const struct Element *, Action );
    STEPCODE_UTILS_EXPORT void               STEPCODE_HASHlistinit( struct Hash_Table *, HashEntry * );
    STEPCODE_UTILS_EXPORT void               STEPCODE_HASHlistinit_by_type( struct Hash_Table *, HashEntry *, char );
    STEPCODE_UTILS_EXPORT struct Element  *  STEPCODE_HASHlist( HashEntry * );

#ifdef __cplusplus
}
#endif

#endif /* STEPCODE_HASH_H */
