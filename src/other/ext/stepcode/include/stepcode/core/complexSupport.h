...
class STEPCODE_CORE_EXPORT EntNode {
...
class STEPCODE_CORE_EXPORT EntList {
...
class STEPCODE_CORE_EXPORT SimpleList : public EntList {
        friend class ComplexList;
 ...
 */
class STEPCODE_CORE_EXPORT MultList : public EntList {
 ...
 */
class STEPCODE_CORE_EXPORT JoinList : public MultList {
    public:
...
class STEPCODE_CORE_EXPORT AndOrList : public JoinList {
        friend class ComplexList;
...
class STEPCODE_CORE_EXPORT AndList : public JoinList {
        friend class ComplexList;
...
class STEPCODE_CORE_EXPORT OrList : public MultList {
    public:
 ...
 */
class STEPCODE_CORE_EXPORT ComplexList {
...
class STEPCODE_CORE_EXPORT ComplexCollect {
    public:
