...
class STEPCODE_CORE_EXPORT STEPaggregate :  public SingleLinkList {
    protected:
        int _null;
 ...
 ******************************************************************/
class STEPCODE_CORE_EXPORT GenericAggregate  :  public STEPaggregate {
    public:
        virtual SingleLinkNode * NewNode();
        virtual STEPaggregate & ShallowCopy( const STEPaggregate & );
...
class STEPCODE_CORE_EXPORT EntityAggregate  :  public  STEPaggregate {
    public:
        virtual Severity ReadValue( istream & in, ErrorDescriptor * err,
                                    const TypeDescriptor * elem_type,
                                    InstMgr * insts, int addFileId = 0,
 ...
 ******************************************************************/
class STEPCODE_CORE_EXPORT SelectAggregate  :  public STEPaggregate {
    public:
        virtual Severity ReadValue( istream & in, ErrorDescriptor * err,
                                    const TypeDescriptor * elem_type,
                                    InstMgr * insts, int addFileId = 0,
...
******************************************************************/
class STEPCODE_CORE_EXPORT StringAggregate  :  public STEPaggregate {
    public:
        virtual SingleLinkNode * NewNode();
        virtual STEPaggregate & ShallowCopy( const STEPaggregate & );
...
******************************************************************/
class STEPCODE_CORE_EXPORT BinaryAggregate  :  public STEPaggregate {
    public:
        virtual SingleLinkNode * NewNode();
        virtual STEPaggregate & ShallowCopy( const STEPaggregate & );
...
******************************************************************/
class STEPCODE_CORE_EXPORT EnumAggregate  :  public STEPaggregate {
    public:
        virtual SingleLinkNode * NewNode();
        virtual STEPaggregate & ShallowCopy( const STEPaggregate & );
...
class STEPCODE_CORE_EXPORT LOGICALS  : public EnumAggregate {
    public:
        virtual SingleLinkNode * NewNode();
...
STEPCODE_CORE_EXPORT LOGICALS * create_LOGICALS();


class STEPCODE_CORE_EXPORT BOOLEANS  : public EnumAggregate {
    public:
        virtual SingleLinkNode * NewNode();
...
STEPCODE_CORE_EXPORT BOOLEANS * create_BOOLEANS();

class STEPCODE_CORE_EXPORT RealAggregate  : public STEPaggregate  {
...
class STEPCODE_CORE_EXPORT IntAggregate  : public STEPaggregate  {
...
class STEPCODE_CORE_EXPORT STEPnode :  public SingleLinkNode  {
    protected:
        int _null;
...
class STEPCODE_CORE_EXPORT GenericAggrNode  : public STEPnode {
    public:
        SCLundefined value;
//  INPUT
        virtual Severity StrToVal( const char * s, ErrorDescriptor * err );
...
class STEPCODE_CORE_EXPORT EntityNode  : public STEPnode {
    public:
...
******************************************************************/
class STEPCODE_CORE_EXPORT SelectNode  : public STEPnode {
    public:
        SDAI_Select  * node;
//  INPUT
        virtual Severity StrToVal( const char * s, ErrorDescriptor * err,
...
******************************************************************/
class STEPCODE_CORE_EXPORT StringNode  : public STEPnode {
    public:
        SDAI_String  value;
//  INPUT
        virtual Severity StrToVal( const char * s, ErrorDescriptor * err );
...
******************************************************************/
class STEPCODE_CORE_EXPORT BinaryNode  : public STEPnode {
    public:
        SDAI_Binary  value;
//  INPUT
        virtual Severity StrToVal( const char * s, ErrorDescriptor * err );
...
******************************************************************/
class STEPCODE_CORE_EXPORT EnumNode  : public STEPnode {
    public:
        SDAI_Enum  * node;
//  INPUT
        virtual Severity StrToVal( const char * s, ErrorDescriptor * err );
...
class STEPCODE_CORE_EXPORT RealNode  : public STEPnode {
    public:
...
class STEPCODE_CORE_EXPORT IntNode  : public STEPnode {
    public:
