...
extern STEPCODE_CORE_EXPORT const SDAI_Integer SDAI_INT_NULL;
extern STEPCODE_CORE_EXPORT const SDAI_Real SDAI_REAL_NULL;
// arbitrary choice by me for number DAS
extern STEPCODE_CORE_EXPORT const SDAI_Real SDAI_NUMBER_NULL;
...
//  SDAI_sdaiED_NAVL =  250,   // Entity definition not available
    ...
    SDAI_sdaiSTEPCODE_NEXS =  360,   // Scope does not exist
    SDAI_sdaiSTEPCODE_EXS =  370,   // Scope exists
...
//  ENTITY
extern STEPCODE_CORE_EXPORT SDAI_Application_instance NilSTEPentity;
...
extern STEPCODE_CORE_EXPORT SDAI_Application_instance *
