...
extern STEPCODE_EXPRESS_EXPORT struct freelist_head ENTITY_fl;
extern STEPCODE_EXPRESS_EXPORT int ENTITY_MARK;
...
extern STEPCODE_EXPRESS_EXPORT struct Scope_  * ENTITYcreate PROTO( ( struct Symbol_ * ) );
extern STEPCODE_EXPRESS_EXPORT void     ENTITYinitialize PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT void     ENTITYadd_attribute PROTO( ( struct Scope_ *, struct Variable_ * ) );
extern STEPCODE_EXPRESS_EXPORT struct Scope_  * ENTITYcopy PROTO( ( struct Scope_ * ) );
extern STEPCODE_EXPRESS_EXPORT Entity       ENTITYfind_inherited_entity PROTO( ( struct Scope_ *, char *, int ) );
extern STEPCODE_EXPRESS_EXPORT Variable     ENTITYfind_inherited_attribute PROTO( ( struct Scope_ *, char *, struct Symbol_ ** ) );
extern STEPCODE_EXPRESS_EXPORT Variable     ENTITYresolve_attr_ref PROTO( ( Entity, Symbol *, Symbol * ) );
extern STEPCODE_EXPRESS_EXPORT bool      ENTITYhas_immediate_supertype PROTO( ( Entity, Entity ) );
extern STEPCODE_EXPRESS_EXPORT Variable     ENTITYget_named_attribute PROTO( ( Entity, char * ) );
extern STEPCODE_EXPRESS_EXPORT Linked_List  ENTITYget_all_attributes PROTO( ( Entity ) );
extern STEPCODE_EXPRESS_EXPORT bool      ENTITYhas_supertype PROTO( ( Entity, Entity ) );
extern STEPCODE_EXPRESS_EXPORT void     ENTITYadd_instance PROTO( ( Entity, Generic ) );
extern STEPCODE_EXPRESS_EXPORT int      ENTITYget_initial_offset PROTO( ( Entity ) );
extern STEPCODE_EXPRESS_EXPORT int      ENTITYdeclares_variable PROTO( ( Entity, struct Variable_ * ) );
