...
extern STEPCODE_EXPRESS_EXPORT void orderedAttrsInit( Entity e );

///free memory
extern STEPCODE_EXPRESS_EXPORT void orderedAttrsCleanup();

///get next attr; not thread safe (as if the rest of libexpress is)
extern STEPCODE_EXPRESS_EXPORT const orderedAttr * nextAttr();
#ifdef __cplusplus
}
