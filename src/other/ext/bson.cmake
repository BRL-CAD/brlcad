...
if (BRLCAD_BSON_BUILD)
  ...
  if (MSVC)
    ...
    set(BSON_SYMLINK_2 ${BSON_BASENAME}${CMAKE_SHARED_LIBRARY_SUFFIX}.${BSON_MAJOR_VERSION})
  elseif (APPLE)
    set(BSON_BASENAME libbson-1.0)
    set(BSON_SUFFIX .${BSON_VERSION}${CMAKE_SHARED_LIBRARY_SUFFIX})
    set(BSON_SYMLINK_1 ${BSON_BASENAME}${CMAKE_SHARED_LIBRARY_SUFFIX})
    set(BSON_SYMLINK_2 ${BSON_BASENAME}.${BSON_MAJOR_VERSION}${CMAKE_SHARED_LIBRARY_SUFFIX})
  else (MSVC)
    set(BSON_BASENAME libbson-1.0)
