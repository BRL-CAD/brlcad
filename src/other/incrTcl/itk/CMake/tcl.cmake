...
MACRO(SC_TCL_LINK_LIBS)
	...
	IF(TCL_LINK_LIBS)
		SET(TCL_LINK_LIBS "${TCL_LINK_LIBS};${IEEE_LIBRARY};${M_LIBRARY};${INET_LIBRARY}")
	...
	IF(NOT HAVE_CONNECT)
		...
		IF(NOT HAVE_SETSOCKOPT)
			CONFIG_CHECK_LIBRARY(SOCKET socket connect)
			IF(TCL_LINK_LIBS)
	...
	IF(NOT HAVE_GETHOSTBYNAME)
		CONFIG_CHECK_LIBRARY(NSL nsl gethostbyname)
		IF(NSL_LIBRARY)
			IF(TCL_LINK_LIBS)
