...
proc ::mged::xmin::editors::confirm_combination_overwrite {button} {
    ::mged::gui::test::with_dialog_answer .mged_dialog Warning! "" "" \
...
proc ::mged::xmin::editors::exercise_combination {id top} {
    ...
    ::mged::gui::test::invoke $top {Edit {Combination Editor}}
    set editor .$id.comb
    ::gui::test::require {
	[winfo exists $editor] && [winfo ismapped $editor]
    } "Combination Editor did not open"

    ::mged::gui::test::set_entry $editor.nameE xmin_group.c
    focus $editor.nameE
    ...
    ::gui::test::require {![winfo exists $editor]} \
...
proc ::mged::xmin::editors::load_attribute_object {editor object_name} {
    ...
    ::mged::gui::test::set_entry $object_entry $object_name
    focus $object_entry
...
proc ::mged::xmin::editors::select_attribute {listbox name} {
    ...
    if {$index < 0} {
	::mged::gui::test::fail "Attribute Editor did not list '$name'"
    }
...
proc ::mged::xmin::editors::exercise_attributes {id top} {
    ::mged::gui::test::invoke $top {Edit {Attribute Editor}}
    ...
    set listbox [::mged::gui::test::find_descendant $editor Listbox]
    set value_text [::mged::gui::test::find_descendant $editor Text]
    ...
    ::gui::test::require {[attr get xmin_attr.s existing] eq "changed"} \
...
proc ::mged::xmin::editors::run {id top} {
    set database [file join $::env(GUI_TEST_DIR) editors.g]
    cd $::env(GUI_TEST_DIR)
    ...
    ::gui::test::exercise_sketch_segments Sketch_carc Sketch_bezier MGED ::mged::xmin::editors
    exercise_combination $id $top
    exercise_attributes $id $top
}

::mged::gui::test::start ::mged::xmin::editors::run \
