...
proc ::mged::xmin::overlaps::exercise_overlap_tool {top database} {
    ...
    ::mged::xmin::test::invoke $top {Tools {Overlaps Tool}}
    set menu .overlapmenu.overlapmenu
    ::mged::xmin::test::require_mapped $menu "Overlap Menu"
    ...
    ::mged::xmin::test::require_mapped $tool "Overlap File Tool"
    $tool clearSelection
    ::mged::xmin::test::set_entry $tool.ovFrame.objectsEntry \
	{first.g second.g}
    ...
    ::mged::xmin::test::require_mapped $checker "Geometry Checker"
    set tree $checker.checkFrame.checkList
    set rows [$tree children {}]
    ::xmin::test::require {[llength $rows] == 2} \
    ...
    ::mged::xmin::test::settle
    ::xmin::test::require {[llength [who]] >= 2} \
    ...
    ::xmin::test::require {![$tree tag has marked $first_row]} \
	"Geometry Checker did not clear a resolved mark"
    destroy .checker
}

proc ::mged::xmin::overlaps::run {id top} {
    set database [file join $::env(XMIN_TEST_DIR) overlaps.g]
...
::mged::xmin::test::start ::mged::xmin::overlaps::run \
