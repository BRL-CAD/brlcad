...
EXTERN time_t	TclpGetClicks _ANSI_ARGS_((void));
EXTERN time_t	TclpGetSeconds _ANSI_ARGS_((void));
EXTERN void		TclpGetTime _ANSI_ARGS_((Tcl_Time *time));
EXTERN int		TclpGetTimeZone _ANSI_ARGS_((time_t time));
