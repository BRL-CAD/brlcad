...
|*rt -l8 heat graph*: Heat-graph diagnostic mode maps the elapsed CPU time needed to render each fully shaded pixel to grayscale; brighter pixels took longer to render.
|===
