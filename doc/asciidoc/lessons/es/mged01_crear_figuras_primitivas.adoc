...
* Usar el comando "tops" para identificar los objetos de nivel superior de la base de datos.
...
El comando *ls* muestra todos los objetos, lo cual puede resultar abrumador
en una base de datos existente. El comando *tops* suele ser el mejor punto de
partida para explorar una base de datos desconocida: muestra únicamente los
objetos que no son miembros de otra combinación. Estos objetos de nivel
superior suelen ser los ensamblajes o modelos que conviene dibujar o examinar
primero. En la ventana de línea de comandos, escriba: *tops [ENTER].*

En la base de datos sencilla _sphere.g_, las figuras primitivas todavía son
objetos de nivel superior. Cuando cree combinaciones en tutoriales posteriores,
*tops* omitirá las figuras que sean miembros y mostrará los puntos de entrada
de nivel superior.
...
* Utilizó el comando tops para identificar objetos de nivel superior.
