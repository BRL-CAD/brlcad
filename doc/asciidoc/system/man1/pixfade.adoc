...
The *-o* option supplies output file name. If standard output is also redirected or piped, *pixfade* writes the same output to both destinations. If this option is omitted, standard output is used.
