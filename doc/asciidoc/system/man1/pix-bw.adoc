...
*pix-bw* will combine or select the color planes of a *pix*(5) format file from its standard input and produce a black and white *bw*(5) file on its standard output. If *-o* is specified and standard output is also redirected or piped, *pix-bw* writes the same output to both destinations.
