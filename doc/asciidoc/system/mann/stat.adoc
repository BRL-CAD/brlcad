...
[source]
----
stat [-h] [-?] [-v] [-q] [-r] [-F string] [-C type1[,type2]...] [-S type1[,type2]...] [-o filename] {glob pattern}
----
...
The GED *stat* command reports information about objects in a BRL-CAD `.g`
file. It produces a configurable table and can filter, sort, and redirect the
reported results.
...
*-v*, *--verbosity*::
Increase output verbosity. Repeating *-v* increases it further.


*-q*, *--quiet*::
Decrease output verbosity. Repeating *-q* decreases it further.
