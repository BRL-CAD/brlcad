...
* sxscale -- Enters solid scale (x-direction only) mode (must be in primitive edit mode).
* syscale -- Enters solid scale (y-direction only) mode (must be in primitive edit mode).
* szscale -- Enters solid scale (z-direction only) mode (must be in primitive edit mode).
