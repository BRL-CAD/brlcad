...
The numeric form requires exactly `low high red green blue`.  The color channels
are decimal integers from 0 through 255.  The `-e` editing form cannot be
combined with numeric color-record values.
