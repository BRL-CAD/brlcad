...
[source]
----
make [-h] [-t] [-o "x y z"] [-s scale] new_shape type
----
...
The *-h* option prints usage help. The *-o* option specifies the origin for the
new primitive and the *-s* option sets the initial size scale used when
