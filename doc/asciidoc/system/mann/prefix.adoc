...
== NAME
prefix - Changes the name of all the _objects_ listed by adding the specified __new_prefix__.
...
Changes the name of all the _objects_ listed by adding the specified __new_prefix__. All references to the _objects_ will also be changed. The *mvall* command performs a similar function.
