...
[source]
----
intersect [-o output_obj] [-h] {obj1 obj2 [...]}
----


[source]
----
subtract [-o output_obj] [-h] {obj1 obj2 [...]}
----
...
If a primitive advertises a metric but cannot calculate it, the summary
reports *COULD NOT DETERMINE* for that value and the command returns an
error. Other available metrics and summaries for subsequent objects are
still reported.
...
object in question (returning 1 if inside and 0 otherwise.)
