...
If a primitive advertises an analytic metric but cannot calculate it,
the summary reports *COULD NOT DETERMINE* for that value and the command
returns an error.  Other available metrics and summaries for subsequent
