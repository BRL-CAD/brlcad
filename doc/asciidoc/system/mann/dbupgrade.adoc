...
.Start an interactive database upgrade.
[example]
====
mged> **dbupgrade**

Prompts to upgrade the currently open database and writes a backup with the original pre-upgrade file contents.
...
Prints the upgrade explanation and command usage without changing the database.
